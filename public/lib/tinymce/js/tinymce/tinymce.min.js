...
!(function () {
        ...
        Qe = [
            {
                ...
                search: (e) =>
                    Ue(e, 'edge/') && Ue(e, 'chrome') && Ue(e, 'safari') && Ue(e, 'applewebkit'),
            },
            {
                name: 'Chromium',
                brand: 'Chromium',
    ...
    const Ct = () => yt(),
        ...
        Lt = (e, t, n) =>
            e.isSome() && t.isSome() ? M.some(n(e.getOrDie(), t.getOrDie())) : M.none(),
    ...
    const Mt = (e) => e.dom.nodeName.toLowerCase(),
        ...
        ho = (e) => {
            ...
            return ((e) => {
                ...
                (e) =>
                    po(Math.max(e.pageLeft, o.left), Math.max(e.pageTop, o.top), e.width, e.height),
            )
        },
    ...
    class Xo {
        ...
        next(e) {
            return (
                (this.node = this.findSibling(this.node, 'firstChild', 'nextSibling', e)), this.node
            )
        }
        prev(e) {
            return (
    ...
    const Qo = (e) => {
        ...
        Cr = (e) => {
            ...
            return (
                !!No(t) &&
                (t.data.charAt(e.offset()) === ur || (e.isAtStart() && br(t.previousSibling)))
            )
        },
        xr = (e) => {
            const t = e.container()
            return (
                !!No(t) &&
                (t.data.charAt(e.offset() - 1) === ur || (e.isAtEnd() && br(t.nextSibling)))
            )
        },
                    ...
                    (e, t) =>
                        ((e) => -1 !== ' \f\t\v'.indexOf(e))(t) || t === dr
                            ? e.pcIsSpace ||
                              ...
                              ((e, t) => t < e.length && t >= 0 && Ur(e[t]))(s, e.str.length + 1)
    ...
    const qr = (e, t = !0) =>
        ...
        ws = (e, t, n, o) => {
            ...
            return (
                ...
                ((e) => y(e.preventDefault) || ((e) => e instanceof Event || x(e.initEvent))(e))(
                    t,
                ) &&
                    ((s.preventDefault = () => {
                    ...
                    ((e) => e.isDefaultPrevented === P || e.isDefaultPrevented === L)(s) ||
    ...
    class Rs {
                ...
                if (((i = this.events[l]), t)) {
                    ...
                    for (r = l.length; r--; )
                        if (((a = l[r]), (o = i[a]), o)) {
                            ...
                            ;(n && 0 !== o.length) ||
                                (delete i[a], _s(e, o.fakeName || a, o.nativeHandler, o.capture))
                        }
                } else
                    fe(i, (t, n) => {
        ...
        clean(e) {
            ...
            if (
                ...
                for (this.unbind(e), n = e.getElementsByTagName('*'), t = n.length; t--; )
        ...
        Ls = (e, t) => {
            ...
            if (e)
                for (n = e.nodeType, e = e.previousSibling; e; e = e.previousSibling)
                    (o = e.nodeType),
                        (!t || 3 !== o || (o !== n && e.nodeValue.length)) && (r++, (n = o))
            return r
        },
        Ps = Bt.makeMap(
            ...
            const a = Yo.forElement(mn(e), {
                ...
                B = (e, t, n, o) => {
                    ...
                    for (
                        o = void 0 === o,
                            ...
                            m(t) && ((s = t), (t = '*' === t ? yo : (e) => T(e, s)));
                        a && !(a === n || y(a.nodeType) || To(a) || Bo(a));
                ...
                Q = {
                    ...
                    select: (n, o) => {
                        ...
                        const a =
                            null !==
                                (s = null !== (r = g(o)) && void 0 !== r ? r : t.root_element) &&
                            void 0 !== s
                                ? s
                                : e
        ...
        qs = () => {
            ...
            return {
                ...
                load: (e, o) => {
                    ...
                    0 !== s.indexOf('/') && -1 === s.indexOf('://') && (s = qs.baseURL + '/' + s),
    ...
    const sa = (e) => {
        ...
        fa = (e, t) => (
            (e = ma(e)), t || (e.left = e.left + e.width), (e.right = e.left), (e.width = 0), e
        ),
                    ...
                    (n = ((e) => {
                        ...
                        if (wa(r))
                            if (e.isAtEnd()) {
                                ...
                                Ea(i) && !Aa(i) && (Sa(i) || Sa(a) || !Ea(a)) && n(Fa(Ia(i), !1)),
                                    Ea(a) && n(Fa(Ia(a), !0))
                            }
                        return t
                    })(Ua(e, t))),
    ...
    ;(Ua.fromRangeStart = (e) => Ua(e.startContainer, e.startOffset)),
        ...
        (Ua.isAbove = (e, t) => Lt(ie(t.getClientRects()), le(e.getClientRects()), pa).getOr(!1)),
        (Ua.isBelow = (e, t) => Lt(le(t.getClientRects()), ie(e.getClientRects()), ha).getOr(!1)),
    ...
    const za = (e, t) => {
        ...
        Wa = (e) =>
            e
                ? Oe(
                      e.childNodes,
                      (e, t) => (
                          Ha(t) && 'BR' !== t.nodeName ? (e = e.concat(Wa(t))) : e.push(t), e
                      ),
                      [],
                  )
                : [],
        ...
        Ya = (e, t) => {
            ...
            return (
                ...
                Va(n)
                    ...
                    : ((s = n.childNodes),
                      o >= s.length ? ((r = 'after'), (o = s.length - 1)) : (r = 'before'),
                      (n = s[o])),
                i.push(Ga(n)),
                (a = ((e, t, n) => {
                    const o = []
        ...
        Ja = (e, t, n, o, r) => {
            ...
            for (
                No(s)
                    ...
                    : ((l = s.childNodes),
                      a >= l.length && l.length && ((d = 1), (a = Math.max(0, l.length - 1))),
        ...
        ei = (e, t) => {
            ...
            ;(n = e[s + 'Container']),
                ...
                yo(n) &&
                    ...
                    n &&
                        ((o = t ? 0 : n.childNodes.length), e['set' + (t ? 'Start' : 'End')](n, o)))
        },
        ...
        oi = (e, t, n) => {
            ...
            const a = ((e) =>
                ni(e.startContainer, e.startOffset) || ni(e.endContainer, e.endOffset))(s)
            return a
            ...
            Ua.isTextPosition(t)
                ...
                : ((e, t) =>
                      t.container() === e.parentNode
                          ...
                          : id(e, t))(e, t),
        dd = (e) => {
            nd(e) && vr(e) && (yr(e) ? e.removeAttribute('data-mce-caret') : rd(e)),
                od(e) && (ad(e), 0 === e.data.length && rd(e))
        },
        cd = Mo,
        ud = Fo,
        md = Io,
    ...
    const qd = Mo,
        ...
        Xd = (e) =>
            Tr(e) ||
            ((e) => !!Pr(e) && !0 !== Y(de(e.getElementsByTagName('*')), (e, t) => e || Er(t), !1))(
                e,
            ),
        Qd = Mr,
        ...
        ec = (e, t, n) => {
            ...
            if (t.isEqual(Ua.after(n)) && n.lastChild) {
                if (((a = Ua.after(n.lastChild)), Nd(e) && Yd(n.lastChild) && Kd(n.lastChild)))
                    return Gd(n.lastChild) ? Ua.before(n.lastChild) : a
            } else a = t
            const i = a.container()
            let l = a.offset()
            if (Wd(i)) {
                ...
                if (Nd(e) && l > 0 && ((r = Jd(i, l - 1)), Yd(r)))
                    return !Xd(r) && ((s = Ad(r, e, Qd, r)), s)
                        ? Wd(s)
                            ? Ua(s, s.data.length)
                            : Ua.after(s)
                        : Wd(r)
            ...
            if (
                ((Ed(e) && a.isAtEnd()) || (Nd(e) && a.isAtStart())) &&
                ((o = Ad(o, e, P, n, !0)), Qd(o, n))
            )
                return Zd(e, o)
            r = Ad(o, e, Qd, n)
            const d = Be(
            ...
            return !d || (r && d.contains(r))
                ? r
                    ? Zd(e, r)
                    : null
                : ((a = Ed(e) ? Ua.after(d) : Ua.before(d)), a)
        },
        ...
        rc = (e, t) =>
            !Ua.isTextPosition(e) && !Ua.isTextPosition(t) && e.getNode() === t.getNode(!0),
        sc = (e, t, n) => {
            const o = tc(t)
        ...
        bc = (e, t) => (
            yo(t) && e.isBlock(t) && !t.innerHTML && (t.innerHTML = '<br data-mce-bogus="1" />'), t
        ),
        vc = (e, t) =>
            mc(e).fold(
                L,
                    ...
                    if (((e) => we(e, 'id'))(t))
                        return ((e, t) => {
                            ...
                            return Lt(n, o.or(n), (t, n) => {
                                const o = e.createRng()
                                return (
                                    o.setStart(bc(e, t.container()), t.offset()),
                                    o.setEnd(bc(e, n.container()), n.offset()),
                                    o
                                )
                            })
                        })(n, t)
    ...
    const Nc = (e) => '' !== e && -1 !== ' \f\n\r\t\v'.indexOf(e),
        ...
        Ic = (e, t, n) => {
            ...
            var s
            if (
                (r !== n.endContainer || !(s = r.childNodes[o]) || !/^(IMG)$/.test(s.nodeName)) &&
                yo(r)
            ) {
        ...
        Uc = (e, t) => (
            Mc(t) && (t = t.nodeName), !!e.schema.getTextBlockElements()[t.toLowerCase()]
        ),
        ...
        Vc = (e, t) => (
            x(e) ? (e = e(t)) : C(t) && (e = e.replace(/%(\w+)/g, (e, n) => t[n] || e)), e
        ),
        Hc = (e, t) => (
            (t = t || ''),
            (e = '' + ((e = e || '').nodeName || e)),
        ...
        $c = (e, t) => (
            ('color' !== t && 'backgroundColor' !== t) || (e = Pc(e)),
        ...
        Wc = (e, t) => {
            let n
            return (
                e.getParent(t, (t) => ((n = e.getStyle(t, 'text-decoration')), n && 'none' !== n)),
                n
            )
        },
        ...
        au = (e, t, n, o, r, s) => {
            ...
            const i = e.getParent(n, e.isBlock) || t,
                l = (t, n, o) => {
                    ...
                    return M.from(
                        l(t, n, (e, t) => (Jc(e.parentNode) ? -1 : ((a = e), o(r, e, t))), i),
                    )
                }
            return l(n, o, ru)
        ...
        cu = (e, t, n, o, r) => {
            ...
            for (;;) {
                ...
                for (let t = s[a]; t; t = t[a]) {
                    ...
                    if (
                        !Jc(t) &&
                        (!Do((l = t)) || !l.getAttribute('data-mce-bogus') || l.nextSibling) &&
                        !eu(t, n)
                    )
                        return s
                }
        ...
        mu = (e, t, n, o = !1) => {
            ...
            return (
                ...
                yo(a) &&
                    a.hasChildNodes() &&
                    ((a = ya(a, t.collapsed ? i : i - 1)), No(a) && (i = a.nodeValue.length)),
                (r = nu(l, r)),
                (a = nu(l, a)),
                uu(r) &&
                    ((r = Jc(r) ? r : r.parentNode),
                    (r = t.collapsed ? r.previousSibling || r : r.nextSibling || r),
                    No(r) && (s = t.collapsed ? r.length : 0)),
                uu(a) &&
                    ((a = Jc(a) ? a : a.parentNode),
                ...
                (Xc(d) || d.block_expand) &&
                    ((Xc(d) && No(r) && 0 !== s) || (r = cu(l, n, r, s, !0)),
                    (Xc(d) && No(a) && i !== a.nodeValue.length) || (a = cu(l, n, a, i, !1))),
                Qc(d) &&
                    ((r = iu(l, n, t, r, 'previousSibling')), (a = iu(l, n, t, a, 'nextSibling'))),
                (Gc(d) || Yc(d)) &&
                    ((r = lu(e, n, r, 'previousSibling')),
                    (a = lu(e, n, a, 'nextSibling')),
                    Gc(d) &&
                        (l.isBlock(r) || (r = cu(l, n, r, s, !0)),
                        l.isBlock(a) || (a = cu(l, n, a, i, !1)))),
        ...
        fu = (e, t, n) => {
            const o = t.startOffset,
                ...
                i = (e) => {
                    ...
                    return (
                        0 === s && e.length > 0 && n === a && No(n) && e.splice(e.length - 1, 1), e
                    )
                },
                l = (e, t, n) => {
                    const o = []
                    ...
                    p ||
                        ...
                        (l =
                            null ===
                                ...
                                ? void 0
                                : a.dom),
                        d(l, k) && (z(), (i = e.getStart(!0)), d(i, l) && d(e.getEnd(!0), l))
                            ? M(l)
                            : I())
                },
                U = () => {
    ...
    const qu = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
            ...
            return ((e, t) => {
                const n = ((e, t) =>
                    t.match({
                        ...
                        relative: (t, n) => ({
                            ltr: De(() => ju(e, t, n)),
                            rtl: De(() => M.some(ju(e, n, t))),
                        }),
                        exact: (t, n, o, r) => ({
                            ltr: De(() => Vu(e, t, n, o, r)),
                            rtl: De(() => M.some(Vu(e, o, r, t, n))),
                        }),
                    }))(e, t)
                return ((e, t) => {
                    const n = t.ltr()
        ...
        nm = (e, t, n) => {
            ...
            ((e, t, n) => {
                ...
                return Wu(o, t, n).map((e) =>
                    qu(mn(e.startContainer), e.startOffset, mn(e.endContainer), e.endOffset),
                )
            })(o, r, s))
                .map((e) => {
            ...
            return (
                t &&
                    ...
                    yo(r) &&
                        ...
                        !i ||
                            !Do(i) ||
                            ((e, t) => e.previousSibling && 'A' === e.previousSibling.nodeName)(
                                i,
                            ) ||
                            dm(e, i, !1) ||
                            dm(e, i, !0) ||
            ...
            return (
                t === o && No(t)
                    ? n > 0 &&
                      ...
                      r > n
                          ? ((r -= n),
                            (t = o = fm(o, r).previousSibling),
                            (r = o.nodeValue.length),
                            (n = 0))
                          : (r = 0))
                    : (No(t) && n > 0 && n < t.nodeValue.length && ((t = fm(t, n)), (n = 0)),
                      No(o) &&
                          r > 0 &&
                          r < o.nodeValue.length &&
                          ((o = fm(o, r).previousSibling), (r = o.nodeValue.length))),
    ...
    ;(pm.compareRanges = om),
        (pm.getCaretRangeFromPoint = nm),
        (pm.getSelectedNode = va),
        (pm.getNode = ya)
    const hm = ((e, t) => {
            const n = (t) => {
                    const n = ((e) => {
    ...
    const Cm = (e) => 'textarea' === Mt(e),
        ...
        $m = (e) => {
            ...
            try {
                return (
                    t.setStart(e.start.dom, e.soffset), t.setEnd(e.finish.dom, e.foffset), M.some(t)
                )
            } catch (e) {
                return M.none()
            }
    ...
    const Xm = Is.DOM,
        Qm = (e, t) => {
            const n = hl(e),
                o = Xm.getParent(
                    t,
                    (t) => ((e) => Km.isEditorUIElement(e))(t) || (!!n && e.dom.is(t, n)),
                )
            return null !== o
        },
        Jm = (e, t) => {
        ...
        Zm = (e, t) => {
            e.focusedEditor === t.editor && (e.focusedEditor = null),
                e.activeEditor || (Xm.unbind(document, 'focusin', Ym), (Ym = null))
        },
        ef = (e, t) => {
            ;((e, t) =>
                ((e) =>
                    e.collapsed ? M.from(ya(e.startContainer, e.startOffset)).map(mn) : M.none())(
                    t,
                ).bind((t) => (sr(t) ? M.some(t) : !1 === vn(e, t) ? M.some(e) : M.none())))(
                mn(e.getBody()),
                t,
            )
                .bind((e) => uc(e.dom))
            ...
            e.inline
                ? ((e) => {
                      ...
                      return (
                          ...
                          ((n = mn(t)),
                          Im(n) ||
                              ((o = n), Fm(Pn(o)).filter((e) => o.dom.contains(e.dom))).isSome())
                      )
                      var n, o
                  })(e)
    ...
    class yf {
        ...
        remove() {
            ...
            return (
                t &&
                    (t.firstChild === e ? ((t.firstChild = n), n && (n.prev = null)) : (o.next = n),
                    t.lastChild === e ? ((t.lastChild = o), o && (o.next = null)) : (n.prev = o),
    ...
    const Of = ['font', 'text-decoration', 'text-emphasis'],
        ...
        dg = (e, t) =>
            ((e) => M.from(e.getNode(!0)).map(mn))(t).exists(tr) || ig(!1, e, t).isSome(),
        cg = O(ig, !1),
        ug = O(ig, !0),
        ...
        Ng = (e, t) =>
            ((e, t) => {
                const n = e.container(),
                    o = e.offset()
                return (
                    !1 === Ua.isTextPosition(e) && n === t.parentNode && o > Ua.before(t).offset()
                )
            })(t, e)
        ...
        Rg = (e) => {
            return Lr(e.previousSibling)
                ? M.some(((t = e.previousSibling), No(t) ? Ua(t, t.data.length) : Ua.after(t)))
                : e.previousSibling
                ? mc(e.previousSibling)
                : M.none()
            var t
        },
        Ag = (e) => {
                ...
                e
                    ? ((e, t) =>
                          Ag(t)
                              ...
                              .orThunk(() =>
                                  ((e, t) =>
                                      dc(e, Ua.after(t)).fold(() => cc(e, Ua.before(t)), M.some))(
                                      e,
                                      t,
                                  ),
                              ))(t, n)
            ...
            const i = ((e, t, n) => {
                ...
                return (
                    ...
                    s.isSome() && a.isSome() && i.isSome()
                        ...
                        () => (
                            n &&
                                (o.each((e) => _g(e.dom, e.dom.length)),
                                r.each((e) => Sg(e.dom, 0))),
                            t
                        ),
                    )
        ...
        jg = (e) => (t) =>
            zg(t, e).map((e) => ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, Pg(e))),
        Vg = (e, t, n, o) => {
        ...
        Hg = (e, t) => J(e, (e) => bn(e, t)),
        $g = (e) =>
            Lt(Hg(e.cells, e.rng.start), Hg(e.cells, e.rng.end), (t, n) => e.cells.slice(t, n + 1)),
        qg = (e, t) => {
                      ...
                      Vg(e, t, n, o)
                          ...
                          .bind((e) => {
                              ...
                              if (o && e.cells.length === r.length)
                                  return M.some(Ig.fullTable(e.table))
                              if (r.length > 0) {
        ...
        Kg = (e) => {
            var t
            return (8 === It((t = e)) || '#comment' === Mt(t) ? kn(e) : On(e))
                .bind(Kg)
                .orThunk(() => M.some(e))
        },
        Gg = (e) =>
        ...
        Xg = (e) => {
            ...
            Io(n.dom) && qr(n) ? e.selection.setCursorLocation(n.dom, 0) : e.selection.collapse(!0),
                t.length > 1 && V(t, (e) => bn(e, n)) && $t(n, 'data-mce-selected', '1')
        },
        Qg = (e, t, n) =>
            M.some(() => {
            ...
            return np(o, n).fold(
                () =>
                    ((e, t, n, o) => {
                        ...
                        return tp(n, o).bind((o) =>
                            qr(o)
                                ? op(e, o)
                                : ((e, t, n, o, r) =>
                                      ac(n, e.getBody(), r).bind((e) =>
                                          tp(t, mn(e.getNode())).bind((e) =>
                          ...
                          : ((e, t, n, o) =>
                                np(t, o).fold(
                                    () =>
                                        ((e, t, n) =>
                                            Wg(t, n).bind((t) =>
                                                t.fold(O(Zg, e), O(ep, e), O(Qg, e), O(Jg, e)),
                                            ))(e, t, n),
                                    (t) => ((e, t) => op(e, t))(e, t),
                                ))(e, o, r, t)
                  })(e, n, o)
        ...
        mp = (e, t, n, o) => {
            t.insert && n[o.name]
                ? o.empty().append(new yf('br', 1))
                : (o.empty().append(new yf('#text', 3)).value = dr)
        },
                ...
                if (c && f.length > 1)
                    if (t.isValidChild(c.name, d.name)) {
                        ...
                        gp(t, r, s, u)
                            ...
                            (c = f[0]),
                            (gp(t, r, s, c) || fp(c, 'br')) && c.empty().remove()
                    } else pp(d, t)
                else if (d.parent) {
                    if ('li' === d.name) {
                        let e = d.prev
        ...
        Sp = (e, t, n) => {
            ...
            m === f &&
                ...
                ((e, t) => t && !e.schema.getVoidElements()[t.nodeName])(e, f.firstChild) &&
                ...
                a.isCollapsed() ||
                    ((e) => {
                        ...
                        ;((e, t, n) =>
                            null !== n && n === e.getParent(t.endContainer, kp) && Cu(mn(n), t))(
                            t,
                            n,
                            o,
                        )
            ...
            const g = { context: o.nodeName.toLowerCase(), data: n.data, insert: !0 },
                p = l.parse(t, g)
            if (!0 === n.paste && vp(e.schema, p) && ((e, t) => !!Cp(e, t))(i, o))
                return (r = wp(c, i, a.getRng(), p)), a.setRng(r), t
            if (
                (((e) => {
                    let t = e
            ...
            if ((e._selectionOverrides.showBlockCaretContainer(o), g.invalid)) {
                ...
                hp(f, e.schema),
                    up(l.getNodeFilters(), l.getAttributeFilters(), r),
                    (t = c.serialize(r)),
                    ...
                    if (t) {
                        ...
                        Bt.each(o.select('*[data-mce-fragment]'), (e) => {
                            if (
                                ...
                                ((e, t) => te(Tf(e, t), (e) => !((e) => Af.has(e))(e)))(o, e)
                            )
                                for (
                                    let n = e.parentNode;
                                    C(n) && n !== t && !Bf(o, e, n);
        ...
        Bp = (e, t, n, o, r) => {
            ...
            return (
                ...
                ((t = e.dom.getParent(
                    t,
                    (t) => !!Tp(e, t, n) || t.parentNode === s || !!Pp(e, t, n, o, !0),
                )),
                !!Pp(e, t, n, o, r))
            )
        },
        ...
        Up = (e) =>
            ((e) => {
                const t = []
                for (; e; ) {
                    if ((3 === e.nodeType && e.nodeValue !== Ip) || e.childNodes.length > 1)
                        return []
        ...
        jp = (e) => {
            const t = cn('span')
            return (
                qt(t, { id: Fp, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
                e && Jn(t, un(Ip)),
                t
            )
        },
        ...
        Wp = (e, t, n, o) => {
            ...
            for (
                d = f,
                    3 === f.nodeType && (g !== f.nodeValue.length && (l = !0), (d = d.parentNode));
                d;
    ...
    const Qp = Bt.each,
        ...
        eh = (e, t, n) => {
            ...
            if (
                t &&
                n &&
                ((t = Zp(t, 'previousSibling')), (n = Zp(n, 'nextSibling')), o.compare(t, n))
            ) {
        ...
        ch = (e, t, n) => {
            ...
            return (
                No(o) && n && r >= o.nodeValue.length && (o = new Xo(o, e.getBody()).next() || o),
        ...
        gh = (e, t, n, o, r) => {
            ...
            if ('all' !== t.remove) {
                ih(t.styles, (e, o) => {
                    ;(e = $c(Vc(e, n), o + '')),
                        w(o) && ((o = e), (r = null)),
                        (t.remove_similar || !r || lh(qc(a, r, o), e)) && a.setStyle(i, o, ''),
                        (s = !0)
                }),
                    s &&
                        '' === a.getAttrib(i, 'style') &&
                    ...
                    ih(t.attributes, (e, o) => {
                        ...
                        if (
                            ((e = Vc(e, n)),
                            w(o) && ((o = e), (r = null)),
                            t.remove_similar || !r || lh(a.getAttrib(r, o), e))
                        ) {
                            if (
                                'class' === o &&
                                (e = a.getAttrib(i, o)) &&
                            ...
                            if (
                                (ah.test(o) && i.removeAttribute('data-mce-' + o),
                                'style' === o &&
                                    Co(['li'])(i) &&
                          ...
                          ((n.list_block && lh(t, n.list_block)) ||
                              $(de(t.childNodes), (t) => {
                                  zc(e, a, t.nodeName.toLowerCase())
                                      ? r
                                          ? r.appendChild(t)
                                          : ((r = mh(s, t, a)), s.setAttribs(r, Bi(e)))
                                      : (r = null)
                              })),
                          (((e) => Yc(e) && Xc(e) && Dt(xe(e, 'mixed'), !0))(n) &&
                              !lh(n.inline, t)) ||
                              s.remove(t, !0)
                  })(e, i, t),
                  sh.removed())
        ...
        bh = (e, t, n, o, r) => {
            ...
            const l = e.dom,
                    ...
                    return ((e, t, n, o, r, s, a, i) => {
                        ...
                        if (n) {
                            ...
                            for (let n = o.parentNode; n && n !== s; n = n.parentNode) {
                                ...
                                for (
                                    let n = 0;
                                    n < t.length && ((l = hh(e, t[n], i, l)), null !== l);
                                    n++
                                );
                ...
                f = (e) => {
                    ...
                    return (
                        ((e) => _c(e) && yo(e) && ('_start' === e.id || '_end' === e.id))(n) &&
                ...
                g = (t) => {
                    ...
                    if (a.split) {
                        if (((r = gm(r)), (n = ch(e, r, !0)), (o = ch(e, r)), n !== o)) {
                            ...
                            ;(n = mh(l, n, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                                (o = mh(l, o, 'span', { id: '_end', 'data-mce-type': 'bookmark' }))
                            const e = l.createRng()
                            e.setStartAfter(n),
                                e.setEndBefore(o),
                                fu(l, e, (e) => {
            ...
            if (o) {
                ...
                for (
                    let t = 0;
                    t < s.length && (!s[t].ceFalseOverride || !ph(e, s[t], n, o, o));
                    t++
                );
                Pu(e, t, o, n)
            }
                                ...
                                ? (Xc(s) || (Gc(s) && s.wrapper)) &&
                                      ...
                                      (a = ((e) => {
                                          ...
                                          return t
                                              .map((t) => {
                                                  const n = o.clone(t, !1)
                                                  return (
                                                      d(n), o.replace(n, e, !0), o.remove(t, !0), n
                                                  )
                                              })
                                              .getOr(e)
                                      })(a)),
                                  ...
                                  ((e, t, n, o) => {
                                      !Xc(t) ||
                                          ...
                                          (nh(o, oh(e, 'fontSize'), rh(e, 'fontSize', '')),
                                          e.remove(
    ...
    var Cb = function () {
        ...
        xb = function (e, t) {
            if (
                'object' !== (void 0 === e ? 'undefined' : vb(e)) ||
        ...
        wb = (function e() {
            ...
            var O = {}
            n.isSupported =
                'function' == typeof y && S && void 0 !== S.createHTMLDocument && 9 !== A
            var T = cb,
                B = ub,
                D = mb,
                L = fb,
                ...
                ke = function (e) {
                    ;(Ce && Ce === e) ||
                        ...
                        (he = he =
                            -1 === be.indexOf(e.PARSER_MEDIA_TYPE) ? ve : e.PARSER_MEDIA_TYPE),
                        (ye =
                        ...
                        re &&
                            ((F = Xh({}, [].concat(yb(sb)))),
                            (z = []),
                            !0 === re.html && (Xh(F, Zh), Xh(z, ab)),
                            !0 === re.svg && (Xh(F, eb), Xh(z, ib), Xh(z, db)),
                            !0 === re.svgFilters && (Xh(F, tb), Xh(z, ib), Xh(z, db)),
                            !0 === re.mathMl && (Xh(F, ob), Xh(z, lb), Xh(z, db))),
                        e.ADD_TAGS && (F === U && (F = Qh(F)), Xh(F, e.ADD_TAGS)),
                        e.ADD_ATTR && (z === j && (z = Qh(z)), Xh(z, e.ADD_ATTR)),
                        e.ADD_URI_SAFE_ATTR && Xh(de, e.ADD_URI_SAFE_ATTR),
                        e.FORBID_CONTENTS &&
                            (se === ae && (se = Qh(se)), Xh(se, e.FORBID_CONTENTS)),
                        ne && (F['#text'] = !0),
            ...
            var Ae = function (e) {
                ...
                Be = function (e) {
                    ...
                    return (
                        ...
                        ge === fe ? N.call(t, Y ? 'html' : 'body')[0] : Y ? t.documentElement : a
                    )
                },
                De = function (e) {
                    return _.call(
                ...
                Pe = function (e) {
                    return 'object' === (void 0 === i ? 'undefined' : vb(i))
                        ? e instanceof i
                        : e &&
                              'object' === (void 0 === e ? 'undefined' : vb(e)) &&
                ...
                Ie = function (e) {
                    ...
                    return e instanceof l && !Ae(e)
                        ...
                        : ('noscript' !== o && 'noembed' !== o) ||
                          !Kh(/<\/no(script|embed)/i, e.innerHTML)
                        ? (G &&
                              3 === e.nodeType &&
                              ((t = e.textContent),
                              (t = $h(t, T, ' ')),
                              (t = $h(t, B, ' ')),
                              e.textContent !== t &&
                                  (jh(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
                ...
                (n.sanitize = function (e, r) {
                    ...
                    if (((pe = !e) && (e = '\x3c!--\x3e'), 'string' != typeof e && !Pe(e))) {
                        ...
                        if ('string' != typeof (e = e.toString()))
                            throw Gh('dirty is not a string, aborting')
                    }
                    if (!n.isSupported) {
                        if (
                            'object' === vb(t.toStaticHTML) ||
                    ...
                    if ((X || ke(r), (n.removed = []), 'string' == typeof e && (oe = !1), oe)) {
                        if (e.nodeName) {
                            var m = ye(e.nodeName)
                            if (!F[m] || H[m])
                                throw Gh('root node is forbidden and cannot be sanitized in-place')
                        }
                    ...
                    return (
                        Y &&
                            ...
                            Kh(bb, a.ownerDocument.doctype.name) &&
    ...
    class Mb {
        constructor(e, t) {
            ...
            if (
                ...
                const t = this.settings.base_uri
                    ...
                    : new Mb(document.location.href).directory
        ...
        toRelative(e) {
            ...
            const o = this.getURI(),
                r = n.getURI()
            return o === r || ('/' === o.charAt(o.length - 1) && o.substr(0, o.length - 1) === r)
                ? o
    ...
    const Ib = Bt.makeMap,
        ...
        $b = (e, t) => {
            ...
            return (
                ...
                n.addHook('uponSanitizeAttribute', (n, r) => {
                    ...
                    ;(r.keepAttr = !o || t.isValid(s, a) || ze(a, 'data-') || ze(a, 'aria-')),
                        a in Vb && Pb(e, i, s) && (r.keepAttr = !1),
                        r.keepAttr
                    ...
                    parse: (e, n = {}) => {
                        ...
                        const [f, g] = ((e, t, n, o) => {
                                const r = n.validate,
                                    ...
                                    i = zb(
                                        Ib('script,style,head,html,body,title,meta,param'),
                                        t.getBlockElements(),
                                    ),
                                    l = /[ \t\r\n]+/g,
                                    d = /^[ \t\r\n]+/,
                        ...
                        if (
                            (((e, t, n) => {
                                ...
                                for (let n = e, r = n; C(n); r = n, n = n.walk())
                                    $(t, (e) => e(n)), y(n.parent) && n !== e ? (n = r) : o.push(n)
                                for (let e = o.length - 1; e >= 0; e--) {
                                    const t = o[e]
                                    $(n, (e) => e(t))
                                }
        ...
        Kb = (e, t) => {
            ...
            if (_p(e)) {
                if (o.content !== n) {
                    const t = Wb({ validate: !1, forced_root_block: !1 }).parse(o.content, {
                        context: e.name,
                    })
                    return { ...o, content: t }
                }
        ...
        Gb = (e, t) => {
            if (t.no_events) return di.value(t)
            {
                ...
                return n.isDefaultPrevented()
                    ? di.error(Iu(e, { content: '', ...n }).content)
                    : di.value(n)
            }
        },
        ...
        bv = (e, t, n) => {
            ...
            'fragmented' === t.type
                ...
                : e.setContent(t.content, {
                      format: 'raw',
                      no_selection: !C(o) || !hc(o) || !o.isFakeCaret,
                  }),
        ...
        Cv = (e, t) =>
            !(!e || !t) &&
            (!!((e, t) => vv(e) === vv(t))(e, t) || ((e, t) => yv(e) === yv(t))(e, t)),
        xv = (e) => 0 === e.get(),
        wv = (e, t, n) => {
            xv(n) && (e.typing = t)
        },
        ...
        Sv = (e) => ({
            ...
            undoManager: {
                ...
                add: (t, n, o, r, s, a) =>
                    ((e, t, n, o, r, s, a) => {
                        const i = hv(e)
                        if (((s = s || {}), (s = Bt.extend(s, i)), !1 === xv(o) || e.removed))
                            return null
                ...
                undo: (t, n, o) =>
                    ((e, t, n, o) => {
                        let r
                        return (
                            t.typing && (t.add(), (t.typing = !1), wv(t, !1, n)),
                            o.get() > 0 &&
                                (o.set(o.get() - 1),
                                (r = t.data[o.get()]),
                                bv(e, r, !0),
                ...
                hasUndo: (t, n) =>
                    ((e, t, n) => n.get() > 0 || (t.typing && t.data[0] && !Cv(hv(e), t.data[0])))(
                        e,
                        t,
                        n,
                    ),
                ...
                transact: (e, t, n) =>
                    ((e, t, n) => (kv(e, t), e.beforeChange(), e.ignore(n), e.add()))(e, t, n),
                ignore: (e, t) =>
                    ((e, t) => {
                        try {
                            e.set(e.get() + 1), t()
            ...
            formatter: {
                        ...
                        return M.from(e.selection.getStart(!0))
                            .bind((o) =>
                                Ap(
                                    ...
                                    (n) =>
                                        ce(t, (t) =>
                                            ((t, n) => (Pp(e, t.dom, n) ? M.some(n) : M.none()))(
                                                n,
                                                t,
                                            ),
                                        ),
                ...
                toggle: (t, n, o) =>
                    ((e, t, n, o) => {
                        const r = e.formatter.get(t)
                        !Mp(e, t, n, o) || ('toggle' in r[0] && !r[0].toggle)
                            ? xh(e, t, n, o)
                            : bh(e, t, n, o)
                    })(e, t, n, o),
                ...
                getContent: (t) =>
                    ((e, t) =>
                        M.from(e.getBody()).fold(
                            N('tree' === t.format ? new yf('body', 11) : ''),
                            (n) =>
                                ((e, t, n) => {
                                    let o
                                    return (
                                          ...
                                          if (0 === n.length || /^\s+$/.test(n)) {
                                              ...
                                              return (
                                                  e.schema.isValidChild(
                                                      ...
                                                      ? ((n = r),
                                                        (n = e.dom.createHTML(s, Bi(e), n)))
                                                      : n || (n = r),
                                                  Ep(e, n, o.no_selection),
                                                  { content: n, html: n }
                                              )
                                          }
                                          {
                                              'raw' !== o.format &&
                                                  (n = Rf({ validate: !1 }, e.schema).serialize(
                                                      e.parser.parse(n, {
                                                          isRootContent: !0,
                                                          insert: !0,
                                                      }),
                ...
                (e) => (
                    ...
                    t.filter(zt).map((t) =>
                        ((e, t, n, o) => {
                            ...
                            o
                                ? (Eg(r, s, !1, !o), n.setStart(s, a))
                                : (Eg(s, r, !1, !o), n.setEnd(s, a))
                        })(e, t, n, o),
                    )
                ),
            ).orThunk(() => {
                const e = ((e, t) => e.filter((e) => Tu.isBookmarkNode(e.dom)).bind(t ? Sn : kn))(
                    t,
                    o,
                )
                    .or(t)
                ...
                return e.map((e) =>
                    ((e, t) => {
                        wn(e).each((n) => {
                            ...
                            t && bg(n, Ua(o, 0))
                                ? Sg(o, 0)
                                : !t && vg(n, Ua(o, o.length)) && _g(o, o.length)
                        })
                    })(e, o),
                )
            })
        ...
        Dv = (e, t, n, o) => {
            ...
            const { selectorChangedWithUnbind: a } = ((e, t) => {
                ...
                u = (e, t) => {
                    ...
                    const a = d()
                    if (
                        ((e = o.dispatch('SetSelectionRange', { range: e, forward: t }).range), a)
                    ) {
                        s = e
                        try {
                    ...
                    !e.collapsed &&
                        ...
                        n &&
                            ...
                            (a.anchorNode === e.startContainer && a.focusNode === e.endContainer) ||
                ...
                f = {
                    ...
                    setCursorLocation: (t, n) => {
                        ...
                        C(t) && C(n)
                            ...
                            : (xu(e, r, o.getBody(), !0), u(r))
                    },
                    getContent: (e) =>
                        ((e, t = {}) =>
                            ((e, t, n) => Nv(e).selection.getContent(t, n))(
                                e,
                    ...
                    getNode: () =>
                        ((e, t) => {
                            ...
                            return (
                                ...
                                3 === o.nodeType &&
                                    3 === r.nodeType &&
                                    ((o = o.length === s ? lf(o.nextSibling, !0) : o.parentNode),
                                    (r = 0 === a ? lf(r.previousSibling, !1) : r.parentNode),
                                    o && o === r))
                                    ? o
                                    : n && 3 === n.nodeType
                                    ? n.parentNode
                    ...
                    getSelectedBlocks: (t, n) =>
                        ((e, t, n, o) => {
                            ...
                            const s = [],
                                a = e.getRoot()
                            if (
                                ((n = e.getParent(n || sf(a, t, t.collapsed), e.isBlock)),
                ...
                })(s, e, o),
                {
                    ...
                    serialize: (n, a = {}) => {
                        const i = { format: 'html', ...a },
                            l = ((e, t, n) =>
                                ((e, t) => e && e.hasEventListeners('PreProcess') && !t.no_events)(
                                    e,
                                    n,
                                )
                                    ? ((e, t, n) => {
    ...
    const uy = (e, t) => {
                        ...
                        (o = ((e, t) => {
                            ...
                            return {
                                findAll: (o, r) => {
                                    r || (r = P)
                                    const s = K(
                                            ((e) => (e ? de(e.getElementsByTagName('img')) : []))(
                                                o,
                                            ),
                                            (t) => {
                                                const n = t.src
        ...
        by = {
            tablecellbackgroundcolor: { styles: { backgroundColor: '%value' }, ...hy },
            tablecellverticalalign: { styles: { 'vertical-align': '%value' }, ...hy },
            tablecellbordercolor: { styles: { borderColor: '%value' }, ...hy },
            tablecellclass: { classes: ['%value'], ...hy },
            tableclass: { selector: 'table', classes: ['%value'], ...py },
            tablecellborderstyle: { styles: { borderStyle: '%value' }, ...hy },
            tablecellborderwidth: { styles: { borderWidth: '%value' }, ...hy },
        },
        vy = N(by),
        yy = Bt.each,
        Cy = Is.DOM,
        xy = (e, t) => {
            ...
            const s = (t && t.schema) || vs({}),
                a = (e) => {
                    ...
                    return (
                        ((e, t) => {
                            t.classes.length && Cy.addClass(e, t.classes.join(' ')),
                                Cy.setAttribs(e, t.attrs)
                        })(t, o),
                        t
                    )
                },
        ...
        ky = (e, t) => {
            ...
            var d
            l.length
                ? (l[0].name || (l[0].name = n), (n = t.selector), (o = xy(l, e)))
                : (o = xy([n], e))
                    ...
                    if (
                        !(
                            ('background-color' === t &&
                                ...
                                ((n = Cy.getStyle(e.getBody(), t, !0)),
                                '#ffffff' === Pc(n).toLowerCase())) ||
                            ('color' === t && '#000000' === Pc(n).toLowerCase())
                        )
                    ) {
                        ...
                        n = (e, o) => {
                            e &&
                                (m(e)
                                    ? (p(o) || (o = [o]),
                                      $(o, (e) => {
                                          v(e.deep) && (e.deep = !Yc(e)),
                                              v(e.split) && (e.split = !Yc(e) || Xc(e)),
                                              v(e.remove) && Yc(e) && !Xc(e) && (e.remove = 'none'),
                                              Yc(e) &&
                                                  Xc(e) &&
                    ...
                    e.on('mouseup keydown', (t) => {
                        ;((e, t) => {
                            ...
                            Hp(e, null, !1),
                                (8 !== t && 46 !== t) ||
                                    !n.isCollapsed() ||
                                    n.getStart().innerHTML !== Ip ||
                                    Hp(e, pc(o, n.getStart())),
                                (37 !== t && 39 !== t) || Hp(e, pc(o, n.getStart()))
                        })(e, t.keyCode)
                    })
                })(e),
                {
        ...
        Ey = (e) => {
            const t = Ws(),
                ...
                r = {
                    ...
                    add: (s, a) =>
                        ((e, t, n, o, r, s, a) => Nv(e).undoManager.add(t, n, o, r, s, a))(
                            e,
                            r,
                            o,
                            n,
                    ...
                    transact: (t) =>
                        ((e, t, n, o) => Nv(e).undoManager.transact(t, n, o))(e, r, n, t),
                    ignore: (t) => {
                        ;((e, t, n) => {
                        ...
                        e.on('init', () => {
                            ...
                            e.on('keydown', (e) => {
                                ...
                                !(s < 16 || s > 20) ||
                                    ...
                                    t.typing ||
                                    a ||
                                    (t.beforeChange(), wv(t, !0, n), t.add({}, e), o.set(!0))
                            }),
                            e.on('mousedown', (e) => {
                                t.typing && r(e)
                            }),
                    ...
                    () =>
                        ((e, t, n) => {
                            ...
                            return !1 === t && Kf(r)
                                ...
                                : ((e, t, n) =>
                                      ((e, t) => {
                                          ...
                                          ? ((e, t) =>
                                                e && Mo(t.nextSibling)
                                                    ? M.some(uC.moveToElement(t.nextSibling))
                                                    : !1 === e && Mo(t.previousSibling)
                                                    ? M.some(uC.moveToElement(t.previousSibling))
                            ...
                            (n) => () =>
                                n.fold(
                                    ((e, t) => (n) => (
                                        e._selectionOverrides.hideFakeCaret(), Lg(e, t, mn(n)), !0
                                    ))(e, t),
                                    ((e, t) => (n) => {
        ...
        wC = (e, t) =>
            e
                ? ((e) => {
                      if (vC(e.previousSibling))
                          return (
                              CC(e.previousSibling) || e.previousSibling.appendData(ur),
                              e.previousSibling
                          )
                ...
                : ((e) => {
                      if (vC(e.nextSibling))
                          return yC(e.nextSibling) || e.nextSibling.insertData(0, ur), e.nextSibling
        ...
        IC = (e) => {
            return (
                !1 ===
                ((t = UC(e)),
                'rtl' === Is.DOM.getStyle(t, 'direction', !0) || ((e) => Ty.test(e))(t.textContent))
            )
            var t
        },
        ...
        qC = (e, t) =>
            e
                ? t.fold(_(M.some, AC.start), M.none, _(M.some, AC.after), M.none)
                : t.fold(M.none, _(M.some, AC.before), M.none, _(M.some, AC.end)),
        WC = (e, t, n) => {
            const o = e ? 1 : -1
            return (
    ...
    const GC = (e, t) => (e === $d.Backwards ? ne(t) : t),
        ...
        XC = (e, t, n, o) =>
            Do(o.getNode(t === $d.Forwards)) ? KC.Br : !1 === Td(n, o) ? KC.Block : KC.Wrap,
        QC = (e, t, n, o) => {
            const r = tc(n)
            let s = o
            const a = []
            for (; s; ) {
                ...
                if (Do(n.getNode(!1)))
                    return t === $d.Forwards
                        ? { positions: GC(t, a).concat([n]), breakType: KC.Br, breakAt: M.some(n) }
                        : { positions: GC(t, a), breakType: KC.Br, breakAt: M.some(n) }
                if (n.isVisible()) {
                    if (e(s, n)) {
                        const e = XC(0, t, s, n)
    ...
    const mx = (e, t, n, o, r, s) => {
                            ...
                            ((e, t, n, o, r) => {
                                ...
                                return sc(e, n, s)
                                    ...
                                    .fold(
                                        () => o.map(jC),
                                        (r) =>
                                            FC(t, n, r).map(O(HC, e, t, n, s, r)).filter(O($C, o)),
                                    )
                                    .filter(IC)
                            })(e, t, n, s, o),
                        )
        ...
        Nx = (e, t, n) =>
            ...
            ((e, t) => {
                ...
                return (
                    ...
                    (e && Cr(o) ? WC(!0, t.selection, o) : !(e || !xr(o)) && WC(!1, t.selection, o))
                )
            })(e, t),
        Rx = (e) => {
            const t = zs(null),
            ...
            if (e.selection.isCollapsed() && ml(e)) {
                ...
                return ((e, t, n, o) => {
                    ...
                    return a
                        .bind((e) =>
                            n
                                ? e.fold(N(M.some(VC(e))), M.none, N(M.some(jC(e))), M.none)
                                : e.fold(M.none, N(M.some(jC(e))), M.none, N(M.some(VC(e)))),
                        )
                        .map(Bx(e, t))
                        .getOrThunk(() => {
                            const i = ac(n, r, o),
                ...
                return !((e, t, n) =>
                    Lt(uc(n), mc(n), (o, r) => {
                        const s = Ly(!0, o),
                            ...
                            i = Ly(!1, t)
                        return e
                            ? dc(n, i).exists((e) => e.isEqual(a) && t.isEqual(s))
        ...
        Gx = (e, t, n) =>
            ce([Kx, hC, cC, (e, n) => Lx(e, t, n), Jy, ap, bC, Ux, tC, Ix], (t) => t(e, n)),
        Yx = (e, t) => {
            e.addCommand('delete', () => {
                ;((e, t) => {
                    Gx(e, t, !1).fold(() => {
        ...
        Xx = (e) =>
            void 0 === e.touches || 1 !== e.touches.length ? M.none() : M.some(e.touches[0]),
        ...
        ew = (e) => {
            ...
            if (
                ...
                ((e, t, n) => V(Xf(mn(n), mn(t)), (t) => Qx(e, t.dom)))(r, a, s)
            )
                return
            const m = n.getRng(),
                f = m.startContainer,
            ...
            for (s = a.firstChild; s; )
                if (Jx(r, s)) {
                    ...
                    i || ((i = t.create(c, Bi(e))), s.parentNode.insertBefore(i, s), (d = !0)),
                        (l = s),
                        (s = s.nextSibling),
                        i.appendChild(l)
        ...
        ow = (e, t) => {
            t.hasAttribute('data-mce-caret') &&
                (Sr(t), e.selection.setRng(e.selection.getRng()), e.selection.scrollIntoView(t))
        },
        rw = (e, t) => {
            const n = ((e) =>
            ...
            if (n)
                return 'compositionstart' === t.type
                    ? (t.preventDefault(), t.stopPropagation(), void ow(e, n))
                    : void (yr(n) && (ow(e, n), e.undoManager.add()))
        },
        sw = Mo,
        aw = (e, t, n) => {
        ...
        iw = (e, t) =>
            ((e, t) => {
                const n = t ? $d.Forwards : $d.Backwards,
                    o = e.selection.getRng()
                return ((e, t, n) => yx(t, e, n, Wf, Kf, sw))(n, e, o).orThunk(
                    () => (aw(e, n, o), M.none()),
                )
        ...
        uw = (e, t) => {
            ...
            return ((e, t) => {
                ...
                if (
                    ((e, t, n) =>
                        t
                            ? ((e, t) => nx(e, t).breakAt.isNone())(e.dom, n)
                            : ((e, t) => tx(e, t).breakAt.isNone())(e.dom, n))(n, t, o)
                ) {
                    const o = ((e, t, n, o) => {
                        const r = cn(n),
                            s = cn('br')
        ...
        bw = (e, t) =>
            ce(
                ((e, t) =>
                    ee(((e) => H(e, (e) => ({ ...fw, action: () => M.none(), ...e })))(e), (e) =>
                        gw(e, t) ? [e] : [],
                    ))(e, t),
                (e) => e.action(),
            ),
        ...
        Nw = (e, t = !1) => {
            return zn(e)
                ...
                : ((n = e), Ko(n, '[contenteditable]')).fold(N(t), (e) => 'true' === Rw(e))
            var n
        },
        ...
        Bw = (e, t, n) => {
            const o = e(t, n)
            return ((e) => e.breakType === KC.Wrap && 0 === e.positions.length)(o) ||
                (!Do(n.getNode()) && ((e) => e.breakType === KC.Br && 1 === e.positions.length)(o))
            ...
            if (!t && Dw(o, s)) {
                const o = ((e, t, n) =>
                    ((e, t) =>
                        ...
                        .orThunk(() =>
                            ie(n.getClientRects()).bind((n) => ZC(ox(e, Ua.before(t)), n.left)),
                        )
            ...
            if (t && Lw(o, s)) {
                const o = ((e, t, n) =>
                    ((e, t) =>
                        ...
                        .orThunk(() =>
                            ie(n.getClientRects()).bind((n) => ZC(rx(e, Ua.after(t)), n.left)),
                        )
            ...
            return ((e, t) =>
                ((e, t, n = L) =>
                    n(t)
                        ...
                        : j(e, Mt(t))
                        ? M.some(t)
                        : qo(t, e.join(','), (e) => pn(e, 'table') || n(e)))(['td', 'th'], e, t))(
        ...
        Gw = (e, t, n) => {
            ...
            {
                const o = ca(Ww)
                return M.from(o.backwards(e, t, Kw(e), n)).map((e) =>
                    qw(e.container, e.container.data.length),
                )
            }
        },
        Yw = (e, t, n) => {
        ...
        Xw = (e, t, n) => {
            ...
            {
                const r = ca(Ww)
                return M.from(r.forwards(e, t, Kw(e), n)).bind((e) =>
                    Xw(e.container, t - o.length, n),
                )
            }
        },
        Qw = (e, t, n, o, r) => {
                    ...
                    ((e, t, n, o = 0) => {
                        ...
                        return Qw(
                            ...
                            if (
                                ...
                                return M.none()
                            const s = Jw(r)
                            return 0 !== s.lastIndexOf(n) || ek(s, n).length < o
                                ? M.none()
                                : M.some({ text: ek(s, n), range: r, triggerChar: n })
                        })
                    })(e, t, n, o),
                (t) => {
                    const o = e.createRng()
    ...
    const ak = (e, t, n) => (e.stype === sk.Error ? t(e.serror) : n(e.svalue)),
        ...
        dk = ak,
        ck = (e) =>
            f(e) && ue(e).length > 100 ? ' removed due to size' : JSON.stringify(e, null, 2),
        ...
        mk = (e, t) => ({
            extract: (n, o) =>
                xe(o, e).fold(
                    () =>
                        ((e, t) =>
                            uk(e, () => 'Choice schema did not contain choice key: "' + t + '"'))(
                            n,
                            e,
                        ),
                    (e) =>
                    ...
                    e.fold(
                        ...
                        (e) => {
                            ...
                            return (
                                (s = n),
                                (a = M.some),
                                s.stype === sk.Value ? { stype: sk.Value, svalue: a(s.svalue) } : s
                            )
                            var s, a
                        },
                    )
        ...
        Sk = (e, t, n) => {
            return (
                (o = ((e, t, n) =>
                    ((e, t) =>
                        e.stype === sk.Error ? { stype: sk.Error, serror: t(e.serror) } : e)(
                        t.extract([e], n),
                        (e) => ({ input: n, errors: e }),
                    ))(e, t, n)),
                ak(o, di.error, di.value)
            )
            var o
        },
        _k = (e, t) => mk(e, ge(t, wk)),
        ...
        nS = wk([
            ...
            Pk('ch'),
            zk('minChars', 1),
            (1, ((e, t) => Bk(e, e, pk(1), Ek()))('columns')),
            zk('maxResults', 10),
            ('matches', Ik('matches', Tk)),
            qk,
            Wk,
    ...
    const rS = [Zk, Xk, Yk, Gk, Kk],
        ...
        aS = [
            Hk('predicate', L),
            jk('scope', 'node', ['node', 'editor']),
            jk('position', 'selection', ['node', 'selection', 'line']),
        ],
    ...
    wk(
        [
            ...
            Hk('initValue', N('')),
            Qk,
            ((e, t) => Bk(e, e, { tag: 'required', process: {} }, kk(t)))('commands', uS),
            Ik('launch', _k('type', { contextformbutton: dS, contextformtogglebutton: cS })),
        ].concat(aS),
    )
    const mS = (e) => {
                ...
                a = (a) => {
                    ;((n) =>
                        t
                            .get()
                            .map((t) =>
                                tk(e.dom, e.selection.getRng(), t.triggerChar).bind((t) =>
                                    rk(e, s, t, n),
                                ),
                            )
                            .getOrThunk(() =>
                                ((e, t) => {
                                    const n = t(),
                                        o = e.selection.getRng()
                                    return ((e, t, n) => ce(n.triggerChars, (n) => tk(e, t, n)))(
                                        e.dom,
                                        o,
                                        n,
                                    ).bind((n) => rk(e, t, n))
        ...
        OS = (e, t) => {
            ...
            const u = e.dom,
                ...
                h = (t) => {
                    ...
                    if (
                        ((n =
                            t || 'TABLE' === d || 'HR' === d ? u.create(t || p) : s.cloneNode(!1)),
                        (a = n),
                        !1 === Pi(e))
                    )
                ...
                b = (e) => {
                    ...
                    for (
                        No(o) &&
                        (e && 0 === a ? i.prev() : e || a !== o.nodeValue.length || i.next());
                        (t = i.current());
                ...
                (o = ((e, t, n, o, r) => {
                    ...
                    if (((a = u.getParent(o, u.isBlock)), !a || !ES(u, a))) {
                        ...
                        if (i && e.schema.isValidChild(c, t.toLowerCase())) {
                            for (
                                s = u.create(t), AS(e, s), i.parentNode.insertBefore(s, i), l = i;
                                l && !u.isBlock(l);
                      ...
                      (hr(s)
                          ...
                          : ((n = ((e) => {
                                ...
                                return (
                                    t.setStart(
                                        e.startContainer,
                                        NS(!0, e.startContainer, e.startOffset),
                                    ),
                                    t.setEnd(e.endContainer, NS(!1, e.endContainer, e.endOffset)),
                                    t
                                )
                            })(g).cloneRange()),
                            n.setEndAfter(s),
        ...
        HS = (e, t) => (n, o) => {
            const r =
                ((e) => vS(e).fold(N(''), (e) => e.nodeName.toUpperCase()))(n) === e.toUpperCase()
            return r === t
        },
        $S = (e) => HS('pre', e),
        qS = (e) => (t, n) => Oi(t) === e,
        ...
        XS = (e, t) => {
            ;((e, t) =>
                RC(
                    [
                        YS([jS], zS.none()),
                        YS([HS('summary', !0)], zS.br()),
                        YS([$S(!0), qS(!1), KS], zS.br()),
                        YS([$S(!0), qS(!1)], zS.block()),
                        YS([$S(!0), qS(!0), KS], zS.block()),
                        YS([$S(!0), qS(!0)], zS.br()),
                        YS([VS(!0), KS], zS.br()),
                        YS([VS(!0)], zS.block()),
                        YS([WS], zS.br()),
                    ...
                    [e, !(!t || !t.shiftKey)],
                ).getOr(zS.none()))(e, t).fold(
                () => {
                    ;(C(t) && hS(e, 'insertLineBreak').isDefaultPrevented()) ||
                        (FS(e, t), C(t) && pS(e, 'insertLineBreak'))
                },
                () => {
                    ;(C(t) && hS(e, 'insertParagraph').isDefaultPrevented()) ||
                        (OS(e, t), C(t) && pS(e, 'insertParagraph'))
                },
                S,
            )
        },
        ...
        e_ = (e, t, n) => {
            n && !e.get() ? t.on('NodeChange', JS, !0) : !n && e.get() && t.off('NodeChange', JS),
                e.set(n)
        },
        t_ = (e, t) => {
            const n = t.container(),
                ...
                return (
                            ...
                            !1 === n.isDefaultPrevented() &&
                                ((e, t, n) => {
                                    ...
                                    bw(
                                        ...
                                        n.preventDefault(),
                                            hS(e, o).isDefaultPrevented() || (t(), pS(e, o))
                                    })
                                })(e, t, n)
                        }),
                            e.on('keyup', (t) => {
                    ...
                    ((e) => {
                        e.on('keydown', (t) => {
                            !1 === t.isDefaultPrevented() &&
                                ((e, t) => {
                                    bw([{ keyCode: Uu.SPACEBAR, action: pw(s_, e) }], t).each(
                                        (n) => {
                                            t.preventDefault(),
                                                hS(e, 'insertText', {
                                                    data: ' ',
                                                }).isDefaultPrevented() ||
                                                    (n(), pS(e, 'insertText', { data: ' ' }))
                                        },
                                    )
                                })(e, t)
                        })
    ...
    class l_ {
        ...
        nodeChanged(e) {
            ...
            this.editor.initialized &&
                ...
                (n = t.getStart(!0) || r),
                (n.ownerDocument === this.editor.getDoc() && this.editor.dom.isChildOf(n, r)) ||
                    (n = r),
                (o = []),
    ...
    const d_ = N('x-tinymce/html'),
        ...
        k_ = (e, t, n) =>
            !!((e, t) => x_(t) && V(ed(e), (e) => je(t.toLowerCase(), `.${e.toLowerCase()}`)))(
                e,
                t,
            ) &&
            ((e, t, n) => (
        ...
        __ = (e, t, n, o) => {
            const r = ((e, t, n) =>
                ((e, t, n) => {
                    const o = ((e, t, n) =>
                            e.dispatch('PastePreProcess', { content: t, internal: n }))(e, t, n),
                        r = ((e, t) => {
                            const n = Wb({}, e.schema)
            ...
            if (zl(e) && o) {
                ...
                if (s.length > 0)
                    return (
                        t.preventDefault(),
                        ((r = s),
                        Promise.all(H(r, (e) => Nb(e).then((t) => ({ file: e, uri: t }))))).then(
                            (t) => {
        ...
        D_ = (e, t, n) => {
            ;((e, t, n) => {
                ...
                e.on('keydown', (e) => {
                    ;((e) =>
                        (Uu.metaKeyPressed(e) && 86 === e.keyCode) ||
        ...
        M_ = (e) => ({
            html: u_(e.selection.getContent({ contextual: !0 })),
                            ...
                            Ul(e) &&
                                ...
                                zl(e) ||
                                    e.on('drop', (e) => {
                                        ...
                                        t &&
                                            ((e) => V(e.files, (e) => /^image\//.test(e.type)))(
                                                t,
                                            ) &&
                                            e.preventDefault()
                                    }),
    ...
    const W_ = (e, t) => Math.abs(e.left - t),
                    ...
                    if (((e) => 0 === e.button)(n)) {
                        ...
                        if (((o = t.getBody()), Z_((r = s)) && r !== o)) {
                            ...
                            e.set({
                                ...
                                ghost: tE(t, s, s.offsetWidth, s.offsetHeight),
                            })
                        }
                    }
                    var o, r
                    ...
                    e.on(
                        ...
                        (t) => {
                            const n = t.target,
                                o = aE(e, n)
                            sE(o)
                                ? (t.preventDefault(), sC(e, o).each(g))
                                : d(n) && sC(e, n).each(g)
                        },
                        !0,
                    ),
                    e.on('mousedown', (o) => {
                            ...
                            ((e, t, n) => {
                                const o = mn(e.getBody()),
                                    ...
                                    s = ((e, t, n, o) => {
                                        ...
                                        return {
                                            x: n - (e ? r.left + t.dom.clientLeft + Qv(t) : 0),
                                            y: o - (e ? r.top + t.dom.clientTop + Xv(t) : 0),
                                        }
                                    })(e.inline, r, t, n)
                                return ((e, t, n) => {
                                    const o = Gv(e),
                        ...
                        sE(a)
                            ...
                            : Q_(r, o.clientX, o.clientY).each((n) => {
                                  var r
                                  o.preventDefault(),
                                      (r = c(1, n.node, n.position === q_.Before, !1)) &&
                                          t.setRng(r),
                                    ...
                                    const t = (t) => {
                                            if (!t.isDefaultPrevented()) {
                                                ...
                                                n &&
                                                    ...
                                                    (t.preventDefault(),
                                                    'drop' === t.type &&
                                                        oy(e, 'Dropped file type is not supported'))
                                            }
                                        },
                                        n = (n) => {
                                            Qm(e, n.target) && t(n)
                            ...
                            e.on('focusin', (t) => {
                                ...
                                if (Fo(n)) {
                                    ...
                                    e.selection.getNode() !== o &&
                                        sC(e, o).each((t) => e.selection.setRng(t))
                                }
                            })
                        })
                    })(e)),
        ...
        cE = (e, t) => {
            const n = t.slice(),
                o = n.pop()
            return Y(n, (e, t) => e.bind((e) => M.from(e.childNodes[t])), M.some(e)).bind((e) =>
                No(e) && (o < 0 || o > e.data.length) ? M.none() : M.some({ node: e, offset: o }),
            )
        },
        uE = (e, t) =>
        ...
        wE = (e, t, n) => {
            ...
            return Yw(a, i - n.pattern.end.length, t).bind((l) => {
                    ...
                    })
                {
                    ...
                    return u.map((e) => {
                        const t = ((e, t) =>
                            dE(e, t.startContainer, t.startOffset, t.endContainer, t.endOffset))(
                            r,
                            e,
                        )
                        return {
                            matches: i.matches.concat([{ pattern: s, startRng: t, endRng: d }]),
                            position: qw(e.startContainer, e.startOffset),
                        }
                    })
                }
            })
                        ...
                        .bind((e) => {
                            ...
                            return r.map((t) =>
                                Bt.trim(o).length === t.start.length
                                    ? []
                                    : [{ pattern: t, range: dE(n.getRoot(), e, 0, e, 0) }],
                            )
                        })
                        .getOr([])
                })(e, t.blockPatterns)
                            ...
                            ((e, t) => {
                                ...
                                $(t, (t) =>
                                    ((e, t) => {
                                        const n = e.dom,
                                            o = t.pattern,
                                            r = uE(n.getRoot(), t.range).getOrDie(
                        ...
                        e.execCommand('mceInsertNewLine'),
                            r.each((t) => {
                                ...
                                n.data.charAt(t.offset - 1) === lr &&
                                    ...
                                    mE(e.dom, n.parentNode, (t) => t === e.dom.getRoot()))
                            })
                    },
                ),
                !0)
        ...
        OE = (e) => {
            ...
            e.on(
                ...
                (t) => {
                    var n
                    13 !== t.keyCode ||
                        Uu.modifierPressed(t) ||
                        (NE(e, ((n = Xl(e)), { inlinePatterns: pi(n), blockPatterns: gi(n) })) &&
                            t.preventDefault())
                },
                !0,
            ),
                e.on('keyup', (t) => {
                    AE(n, t, (e, t) => e === t.keyCode && !1 === Uu.modifierPressed(t)) &&
                        RE(e, o())
                }),
                e.on('keypress', (n) => {
                    ...
                    e.inline ||
                        r.bind(e.getDoc(), 'mousedown mouseup', (t) => {
                            ...
                            if (t.target === e.getDoc().documentElement)
                                if (
                                    ((n = s.getRng()), e.getBody().focus(), 'mousedown' === t.type)
                                ) {
        ...
        UE = (e) => {
            !0 !== e.removed &&
                (((e) => {
                    _v(e) || e.load({ initial: !0, format: 'html' }),
        ...
        zE = (e) => {
            ...
            let n = e.getDoc()
            e.inline &&
                (BE.addClass(t, 'mce-content-body'),
            ...
            ;(o.disabled = !0),
                ...
                e.readonly ||
                    (e.inline &&
                        'static' === BE.getStyle(o, 'position', !0) &&
                            ...
                            t.detail >= 3 &&
                                ((e) => {
                                    ...
                                    if (Ua.isElementPosition(n)) {
                                        const e = n.container()
                                        $_(e) &&
                                            uc(e).each((e) => t.setStart(e.container(), e.offset()))
                                    }
                                    if (Ua.isElementPosition(o)) {
                                        const e = n.container()
                                        $_(e) &&
                                            mc(e).each((e) => t.setEnd(e.container(), e.offset()))
                                    }
                        ...
                        r = (s, a) => {
                            ...
                            const i = e.getBody(),
                                l =
                                    !((e) =>
                                        Ay(e) &&
                                        !(Oy(e) || ('keyup' === e.type && 229 === e.keyCode)))(s) &&
                                    ((e, t, n) => {
                                        if (qr(mn(t), !1)) {
                    ...
                    o &&
                        e.on('init', (t) => {
                            r(t, !0),
                                ...
                                e.on('paste', (t) => Gm.setEditorTimeout(e, () => r(t)))
                        })
                })(e),
                H_(e)
            const s = ((e) => {
        ...
        WE = (e) => {
            e.dispatch('ScriptsLoaded'),
                ...
                ((e) => {
                    ...
                    if (m(t)) {
                        const n = ey.get(t)
                        ;(e.theme = n(e, ey.urls[t]) || {}),
                            x(e.theme.init) &&
                                e.theme.init(e, ey.urls[t] || e.documentBaseUrl.replace(/\/$/, ''))
                    } else e.theme = {}
                })(e),
                ((e) => {
                    const t = cl(e),
                ...
                e.inline
                    ...
                    : ((e, t) => {
                          ;((e, t) => {
                              ...
                              t.editorContainer &&
                                  ((VE.get(t.editorContainer).style.display = e.orgDisplay),
                                  (e.hidden = VE.isHidden(t.editorContainer))),
        ...
        sN = (e, t, n, o, r) => {
            ...
            return ((e, t, n, o) => {
                const r = eN(n.forced_plugins),
                    ...
                    i = ((e, t, n, o) => (e && nN(t, 'mobile') ? o : n))(
                        e,
                        t,
                        s,
                        a.plugins ? eN(a.plugins) : s,
                    ),
        ...
        iN = (e, t) => {
            ...
            return /^ | $/.test(t)
                ? ((e, t, n) => {
                      ...
                      return (
                          (n = bg(o, Ua.fromRangeStart(t))
                              ? n.replace(/^ /, '&nbsp;')
                              : n.replace(/^&nbsp;/, ' ')),
                          vg(o, Ua.fromRangeEnd(t))
                              ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, '&nbsp;')
                              : n.replace(/&nbsp;(<br( \/)?>)?$/, ' ')
                      )
                  })(o, n.getRng(), t)
                    ...
                    ;((e) => {
                        ...
                        e.editorCommands.addCommands({
                            ...
                            FontName: (t, n, o) => {
                                ;((e, t) => {
                                    const n = pN(e, t)
                                    e.formatter.toggle('fontname', { value: hN(n) }),
                                        e.nodeChanged()
                                })(e, o)
                            },
                            FontSize: (t, n, o) => {
                                ;((e, t) => {
                                    e.formatter.toggle('fontsize', { value: pN(e, t) }),
                                        e.nodeChanged()
                                })(e, o)
                            },
                            LineHeight: (t, n, o) => {
                        ...
                        ((e) => {
                            ...
                            e.editorCommands.addCommands(
                                ...
                                e.editorCommands.addQueryValueHandler('FontName', () =>
                                    ((e) => gN(e, (t) => mN(e.getBody(), t.dom)).getOr(''))(e),
                                ),
                                e.editorCommands.addQueryValueHandler('FontSize', () =>
                                    ((e) => gN(e, (t) => uN(e.getBody(), t.dom)).getOr(''))(e),
                                ),
                                    ...
                                    (t
                                        ...
                                        : ((e) => {
                                              ...
                                              if (e.dom.isChildOf(r, n))
                                                  return tf(r), ef(e, o), void of(e)
                                              e.inline ||
                                                  (Nt.browser.isOpera() || tf(n),
                                                  e.getWin().focus()),
    ...
    class vN {
        ...
        execCommand(e, t, n, o) {
            ...
            return (
                !!x(i) &&
                (i(s, t, n), r.dispatch('ExecCommand', { command: e, ui: t, value: n }), !0)
            )
        }
        queryCommandState(e) {
                ...
                : kN(e) &&
                  ((e, t) => {
                      if (((e) => 'click' === e.type)(t) && !Uu.metaKeyPressed(t)) {
                          const n = mn(t.target)
                          ;((e, t) =>
                              Ko(t, 'a', (t) => bn(t, mn(e.getBody()))).bind((e) => Kt(e, 'href')))(
                              e,
                              n,
                          ).each((n) => {
                ...
                'focus' !== e &&
                    ...
                    (n.removed ||
                        (t
                            ...
                            : n.initialized &&
                              (n.dom.unbind(TN(n, e), e, n.delegates[e]), delete n.delegates[e])))
            },
            ...
            jN(VN(e.toLowerCase(), '+'), (e) => {
                e in $N
                    ...
                    : ((n.charCode = e.charCodeAt(0)),
                      (n.keyCode = HN[e] || e.toUpperCase().charCodeAt(0)))
            })
            const r = [n.keyCode]
    ...
    class QN {
        constructor(e, t, n) {
            ...
            ;(this.options = ((e, t) => {
                const n = {},
                    ...
                    r = (e, t, n) => {
                        ...
                        return IN(r)
                            ? ((o[e] = r.value), !0)
                            : (console.warn(MN(`Invalid value passed for the ${e} option`, r)), !1)
                    },
                    s = (e) => we(n, e)
                return {
                    register: (e, s) => {
                        const a = ((e) => m(e.processor))(s)
                            ...
                            i = ((e, t, n) => {
                                if (!v(t)) {
                                    ...
                                    console.error(
                                        MN(`Invalid default value passed for the "${e}" option`, o),
                                    )
                                }
                            })(e, s.default, a)
                    ...
                    t('id', { processor: 'string', default: e.id }),
                        ...
                        e.on('ScriptsLoaded', () => {
                            t('directionality', {
                                ...
                                t('placeholder', {
                                    processor: 'string',
                                    default: yi.getAttrib(e.getElement(), 'placeholder'),
                                })
                        })
                })(o)
            ...
            l &&
                ...
                this.setDirty(!1),
                (this.documentBaseURI = new Mb(Ei(o), { base_uri: this.baseUri })),
                (this.baseURI = this.baseUri),
                (this.inline = bl(o)),
                (this.shortcuts = new WN(this)),
                (this.editorCommands = new vN(this)),
                bN(this)
            ...
            ;((e) => {
                ...
                e.on('remove', () => {
                    ...
                    (e.ui.styleSheetLoader = ((e, t) =>
                        Yo.forElement(e, { contentCssCors: _l(t), referrerPolicy: Ki(t) }))(o, e)),
                    bl(e)
                        ? (e.inline = !0)
                ...
                s &&
                    ...
                    vl(e) &&
                        !Eo(e.getElement()) &&
                        (KE.insertAfter(KE.create('input', { type: 'hidden', name: t }), t),
                        (e.hasHiddenInput = !0)),
        ...
        show() {
            ...
            e.hidden &&
                ...
                e.inline
                    ...
                    : (GN.show(e.getContainer()), GN.hide(e.id)),
                e.load(),
                e.dispatch('show'))
        }
        hide() {
            ...
            e.hidden ||
                ...
                e.inline
                    ...
                    : (GN.hide(e.getContainer()), GN.setStyle(e.id, 'display', e.orgDisplay)),
                (e.hidden = !0),
                e.dispatch('hide'))
        }
        isHidden() {
        ...
        resetContent(e) {
            void 0 === e ? Iv(this, this.startContent, { format: 'raw' }) : Iv(this, e),
        ...
        getContainer() {
            const e = this
            return (
                e.container || (e.container = GN.get(e.editorContainer || e.id + '_parent')),
                e.container
            )
        }
                        ...
                        ? (t ||
                          ...
                          ((e) => {
                              ...
                              t &&
                                  ...
                                  Vv.unbind(t, 'submit reset', e.formEventDelegate))
                          })(e),
                          ((e) => {
    ...
    const oR = (e) => {
        ...
        rR = (e) => {
            if (e !== tR) {
                const t = Is.DOM
                e
                    ? (t.bind(window, 'resize', oR), t.bind(window, 'scroll', oR))
                    : (t.unbind(window, 'resize', oR), t.unbind(window, 'scroll', oR)),
                    (tR = e)
            }
        },
        sR = (e) => {
            ...
            return (
                (nR = K(nR, (t) => e !== t)),
                iR.activeEditor === e && (iR.activeEditor = nR.length > 0 ? nR[0] : null),
                iR.focusedEditor === e && (iR.focusedEditor = null),
                t.length !== nR.length
            )
        },
        ...
        iR = {
            ...
            setup() {
                ...
                let t,
                    n,
                    o = ''
                ;(n = Mb.getDocumentBaseUrl(document.location)),
                    /^[^:]+:\/\/\/?[^\/]+\//.test(n) &&
                        ((n = n.replace(/[\?#].*$/, '').replace(/[\/\\][^\/]+$/, '')),
                        /[\/\\]$/.test(n) || (n += '/'))
                ...
                var s
                ;(e.baseURL = new Mb(n).toAbsolute(t)),
                    (e.documentBaseURL = n),
                    (e.baseURI = new Mb(e.baseURL)),
                    (e.suffix = o),
                    (s = e).on('AddEditor', O(Jm, s)),
                    s.on('RemoveEditor', O(Zm, s))
            },
            overrideDefaults(e) {
                const t = e.base_url
                ...
                if (e) {
                    if (!m(e))
                        return (
                            ...
                            h(t.get(o.id))
                                ? null
                                : (sR(o) && t.dispatch('RemoveEditor', { editor: o }),
                                  0 === nR.length && window.removeEventListener('beforeunload', eR),
                                  o.remove(),
                                  rR(nR.length > 0),
                                  o)
                        )
            ...
            _setBaseUrl(e) {
                ;(this.baseURL = new Mb(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, ''))),
                    (this.baseURI = new Mb(this.baseURL))
            },
        }
    iR.setup()
    const lR = (() => {
