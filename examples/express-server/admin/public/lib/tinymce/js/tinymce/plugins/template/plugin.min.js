...
!(function () {
    ...
    const c = (e) => (t) => t.options.get(e),
        ...
        M = (e, t, a = new Date()) => {
            ...
            return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
                ...
                '%Y',
                '' + a.getFullYear(),
            )).replace('%y', '' + a.getYear())).replace('%m', _(a.getMonth() + 1, 2))).replace(
                '%d',
                _(a.getDate(), 2),
        ...
        T = (e, t) => (
            o.each(t, (t, a) => {
                s(t) && (t = t(a)), (e = e.replace(new RegExp('\\{\\$' + a + '\\}', 'g'), t))
            }),
            e
        ),
        x = (e, t) => {
        ...
        S = (e, t) => new RegExp('\\b' + t + '\\b', 'g').test(e.className),
        w = (e, t, a) => {
            const n = e.dom,
            ...
            l && l.length > 0 && ((s = n.create('div', null)), s.appendChild(l[0].cloneNode(!0))),
                o.each(n.select('*', s), (t) => {
                    S(t, i(e).replace(/\s+/g, '|')) && (t.innerHTML = M(e, g(e))),
                        S(t, u(e).replace(/\s+/g, '|')) && (t.innerHTML = M(e, v(e))),
                        S(t, m(e).replace(/\s+/g, '|')) && (t.innerHTML = r)
                }),
                x(e, s),
    ...
    var O = tinymce.util.Tools.resolve('tinymce.Env')
    const A = Object.hasOwnProperty,
        ...
        I = (e) =>
            e.replace(/["'<>&]/g, (e) => {
                return ((t = D),
                (a = e),
                ((e, t) => A.call(e, t))(t, a) ? C.from(t[a]) : C.none()).getOr(e)
                var t, a
            }),
        N = (e, t) => {
            const a = (e, t) =>
            ...
            ;(() => {
                if (!t || 0 === t.length) {
                    ...
                    return e.notificationManager.open({ text: t, type: 'info' }), C.none()
                }
                return C.from(
                    o.map(t, (e, t) => {
                        ...
                        return {
                            ...
                            text: e.title,
                            value: {
                                url: a(e) ? C.from(e.url) : C.none(),
                                content: a(e) ? C.none() : C.from(e.content),
                    ...
                    i = (t, n, r) => {
                        const s = ((e, t) => {
                            ...
                            c = [
                                ...
                                {
                                    type: 'htmlpanel',
                                    html: `<p aria-live="polite">${I(n.value.description)}</p>`,
                                },
                                {
                                    label: 'Preview',
                                    type: 'iframe',
                ...
                e.on('PreProcess', (t) => {
                    ...
                    o.each(a.select('div', t.node), (t) => {
                        a.hasClass(t, 'mceTmpl') &&
                            (o.each(a.select('*', t), (t) => {
                                a.hasClass(t, u(e).replace(/\s+/g, '|')) && (t.innerHTML = M(e, n))
                            }),
                            x(e, t))
                    })
                })
