...
Для использования npx убедитесь, что у вас установлена Node.js
...
Перед выбором данного типа установки, убедитесь, что у вас установлен и запущен **Docker**, так как он необходим для поднятия базы данных. Кроме того, необходим и node.js версии >14.21.3.
...
Если вы выбрали вариант без backend, у вас будет лишь frontend-оболочка Admiral. Позаботьтесь о backend, изучив подробную API документацию - [Interaction with API](#взаимодействие-с-api)
