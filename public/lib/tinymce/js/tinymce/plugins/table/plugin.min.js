...
!(function () {
                ...
                return null === e
                    ...
                    : 'object' === t &&
                      ...
                      (n = String).prototype.isPrototypeOf(o) ||
                          (null === (r = l.constructor) || void 0 === r ? void 0 : r.name) ===
                              n.name)
                    ? 'string'
                    : t
                var o, l, n, r
    ...
    const V = (e) => e.dom.nodeName.toLowerCase(),
        ...
        ae = (e) => {
            ...
            return ((e) => {
                ...
                var o
            })(j.fromDom(t)).fold(() => o.body.contains(t), ((l = ae), (n = re), (e) => l(n(e))))
            var l, n
        },
        se = (e, t) => {
            let o = []
        ...
        be = (e, t, o) =>
            ((e, t, o, l, n) =>
                ((e, t) => Q(e, t))(o, l) ? f.some(o) : c(n) && n(o) ? f.none() : t(o, l, n))(
                0,
                de,
                e,
                t,
        ...
        Se = (e, t, o) =>
            e.isSome() && t.isSome() ? f.some(o(e.getOrDie(), t.getOrDie())) : f.none(),
        Ce = (e, t) =>
            ((e, t, o) => '' === t || (e.length >= t.length && e.substr(0, 0 + t.length) === t))(
                e,
                t,
            ),
    ...
    const xe = (e) => e.length > 0,
        ...
        De = (e, t, o = 0) =>
            fe(e, t)
                ...
                .getOr(o),
        Ie = (e, t) => Me(e, t, h),
        Me = (e, t, o) => E(le(e), (e) => (Q(e, t) ? (o(e) ? [e] : []) : Me(e, t, o))),
    ...
    const Ge = (e, t, o) =>
        ...
        Je = (e, t) => {
            Ue.each('left center right'.split(' '), (o) => {
                e.formatter.remove('align' + o, {}, t)
            })
        },
        Qe = (e, t, o) => {
            ...
            ((e, t) => {
                ...
                return 'border-box' === t
                    ...
                    : ((e, t, o, l) =>
                          t -
                          Xe(e, 'padding-left', 0) -
                          Xe(e, 'padding-right', 0) -
                          Xe(e, 'border-left-width', 0) -
                          Xe(e, 'border-right-width', 0))(e, l)
            })(e, 'content-box')
    var Ze = tinymce.util.Tools.resolve('tinymce.Env')
    const et = I(5, (e) => {
            const t = `${e + 1}px`
        ...
        ot = (e) => (t) => t.options.get(e),
        lt = ot('table_sizing_mode'),
        nt = ot('table_border_widths'),
        rt = ot('table_border_styles'),
        at = ot('table_default_attributes'),
        st = ot('table_cell_advtab'),
        ct = ot('table_row_advtab'),
        it = ot('table_advtab'),
        mt = ot('table_appearance_options'),
        dt = ot('table_grid'),
        ut = ot('table_style_by_css'),
        pt = ot('table_cell_class_list'),
        bt = ot('table_row_class_list'),
        gt = ot('table_class_list'),
        ht = ot('table_toolbar'),
        ft = ot('table_background_color_map'),
        yt = ot('table_border_color_map'),
        wt = (e) => {
            const t = e.options,
            ...
            return t.isSet('table_default_styles')
                ...
                : ((e, t) => {
                      ...
                      if (((e) => 'fixed' === lt(e))(e)) {
                          const l = e.dom,
                              n =
                                  null !== (o = l.getParent(e.selection.getStart(), l.isBlock)) &&
                                  void 0 !== o
                                      ? o
                                      : e.getBody(),
                              r = Ye(j.fromDom(n))
                      ...
                      return ((e) => 'responsive' === lt(e))(e) ? C(t, (e, t) => 'width' !== t) : t
                  })(e, o)
        },
        St = (e) => (t) => Y(t, ((e) => j.fromDom(e.getBody()))(e)),
        Ct = (e) => (/^\d+(\.\d+)?$/.test(e) ? e + 'px' : e),
        vt = (e) => j.fromDom(e.selection.getStart()),
        Tt = (e, t) =>
            t.column >= e.startCol &&
    ...
    const Pt = (e, t, o, l) => {
        ...
        kt = (e, t, o) => t.bind((t) => o.filter(b(e.eq, t))),
        Bt = {
            up: d({
                selector: de,
                closest: be,
            ...
            property: d({
                ...
                getText: (e) => Mt.get(e),
                setText: (e, t) => Mt.set(e, t),
                isBoundary: (e) => !!$(e) && ('body' === V(e) || O(Nt, V(e))),
        ...
        Ft = (e, t, o) =>
            pe(e, t).bind((t) =>
                pe(e, o).bind((e) => {
                    ...
                    ((e, t, o) =>
                        o.length > 0
                            ? ((e, t, o, l) => l(e, t, o[0], o.slice(1)))(e, t, o, Pt)
                            : f.none())(Bt, (e, t) => o(t), l)).map((o) => ({
                        first: t,
                        last: e,
                        table: o,
                    }))
                        ...
                        ? Be((r = t))
                              .bind((e) =>
                                  ((e, t) =>
                                      ...
                                      })(e, t))(e, Lt.firstSelectedSelector),
                              )
                              .fold(d(r), (e) => e[0])
                        : t
            var r
        ...
        jt = Ht('th,td,caption'),
        Vt = Ht('th,td'),
        zt = (e) => qt(e.model.table.getSelectedCells()),
        Wt = (e, t) => {
            const o = Vt(e),
                l = o.bind((e) => Be(e)).map((e) => Ee(e))
            return Se(o, l, (e, o) =>
                P(o, (o) => D(qt(o.dom.cells), (o) => '1' === he(o, t) || Y(o, e))),
            ).getOr([])
        },
        $t = [
            { text: 'None', value: '' },
        ...
        Ut = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
        Gt = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i,
        Kt = (e) => {
            return ((t = e),
            '#',
        ...
        Qt = (e) => ({ value: Jt(e.red) + Jt(e.green) + Jt(e.blue) }),
        Xt = /^\s*rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)\s*$/i,
        Yt = /^\s*rgba\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?(?:\.\d+)?)\s*\)\s*$/i,
        Zt = (e, t, o, l) => ({ red: e, green: t, blue: o, alpha: l }),
        eo = (e, t, o, l) => {
        ...
        to = (e) => {
            if ('transparent' === e) return f.some(Zt(0, 0, 0, 0))
            const t = Xt.exec(e)
            if (null !== t) return f.some(eo(t[1], t[2], t[3], '1'))
            const o = Yt.exec(e)
            return null !== o ? f.some(eo(o[1], o[2], o[3], o[4])) : f.none()
        },
        oo = (e) => {
            let t = e
            return {
        ...
        ro = (e) =>
            M(e, (e) => {
                ...
                return no(e) ? { text: t, items: ro(e.menu) } : { text: t, value: e.value }
            }),
        ao = (e, t, o, l) =>
            M(t, (t) => {
                ...
                return no(t)
                    ? {
                          type: 'nestedmenuitem',
                          text: n,
                          getSubmenuItems: () => ao(e, t.menu, o, l),
                      }
                    : {
                          text: n,
                          type: 'togglemenuitem',
                          onAction: () => l(t.value),
                          onSetup: lo(e, o, t.value),
                      }
            }),
        so = (e, t) => (o) => {
            e.execCommand('mceTableApplyCellStyle', !1, { [t]: o })
        },
        co = (e) => E(e, (e) => (no(e) ? [{ ...e, menu: co(e.menu) }] : xe(e.value) ? [e] : [])),
        io = (e, t, o, l) => (n) => n(ao(e, t, o, l)),
        mo = (e, t, o) => {
            const l = M(t, (e) => {
                return {
                    text: e.title,
                    value:
                        ...
                        ((o = e.value),
                        ((t = o),
                        ((e) => Ut.test(e) || Gt.test(e))(t) ? f.some({ value: Kt(t) }) : f.none())
                            .orThunk(() => to(o).map(Qt))
                            .getOrThunk(() => {
        ...
        bo = [
            ...
            { name: 'valign', type: 'listbox', label: 'Vertical align', items: $t },
        ],
        go = (e) =>
            bo.concat(
                ((e) => {
                    const t = ro(pt(e))
                    return t.length > 0
                        ? f.some({ name: 'class', type: 'listbox', label: 'Class', items: t })
                        : f.none()
                })(e).toArray(),
            ),
        ho = (e, t) => {
            const o = [
                {
                    ...
                    type: 'listbox',
                    label: 'Border style',
                    items: [{ text: 'Select...', value: '' }].concat(ro(rt(e))),
                },
        ...
        fo = (e) => (t, o) => {
            ...
            return {
                setAttrib: (t, n) => {
                    ;(e && !n) || l.setAttrib(o, t, n)
                },
                setStyle: (t, n) => {
                    ;(e && !n) || l.setStyle(o, t, n)
                },
                setFormat: (l, n) => {
                    ;(e && !n) ||
                        ('' === n
                            ? t.formatter.remove(l, { value: null }, o, !0)
                            : t.formatter.apply(l, { value: n }, o))
                },
            }
        },
        yo = { normal: fo(!1), ifTruthy: fo(!0) },
        wo = J('th'),
        So = (e, t) => (e && t ? 'sectionCells' : e ? 'section' : 'cells'),
        Co = (e) => {
            const t = M(
                    e,
                    (e) =>
        ...
        vo = (e, t) => L(e.all, (e) => B(e.cells, (e) => Y(t, e.element))),
        To = (e, t, o) => {
            const l = ((e) => {
                const t = [],
                    o = (e) => {
                ...
                M(t.selection, (t) => {
                    ...
                    ((e, t, o = g) =>
                        o(t)
                            ...
                            : O(e, V(t))
                            ? f.some(t)
                            : de(t, e.join(','), (e) => Q(e, 'table') || o(e)))(['td', 'th'], l, n))
                        .bind((t) => vo(e, t))
                        .filter(o)
                    var l, n
                }),
        ...
        xo = (e, t) => To(e, t, h),
        Ao = (e, t) => F(t, (t) => ((e, t) => vo(e, t).exists((e) => !e.isLocked))(e, t)),
        Ro = (e, t) => ((e, t) => t.mergable)(0, t).filter((t) => Ao(e, t.cells)),
        _o = (e, t) => ((e, t) => t.unmergable)(0, t).filter((t) => Ao(e, t)),
        Oo =
            (((e) => {
        ...
        Io = (e) => {
            ...
            return {
                ...
                bordercolor: Oe(t, 'border-color').map(Do).getOr(''),
                backgroundcolor: Oe(t, 'background-color').map(Do).getOr(''),
            }
        },
        Mo = (e) => {
            const t = e[0],
        ...
        No = (e, t, o, l) => B(e, (e) => !a(o.formatter.matchNode(l, t + e))).getOr(''),
        Po = b(No, ['left', 'center', 'right'], 'align'),
        ko = b(No, ['top', 'middle', 'bottom'], 'valign'),
        Bo = (e) =>
            Be(j.fromDom(e))
                .map((t) => {
                    const o = { selection: qt(e.cells) }
                    return Oo(t, o)
                })
                .getOr(''),
        Eo = (e, t) => {
                            ...
                            Be(t[0]).each((o) => {
                                ...
                                ;(a || x(n, 'scope')) &&
                                    ((e, t, o) => {
                                        ...
                                        N(t, (t) => {
                                            const n = t.element,
                                                r = l ? yo.normal(e, n) : yo.ifTruthy(e, n)
                                            ;((e, t, o) => {
                                                e.setAttrib('scope', o.scope),
                                                    e.setAttrib('class', o.class),
                                                    e.setStyle('height', Ct(o.height)),
                                                    t.setStyle('width', Ct(o.width))
                                            })(
                                                r,
                                                t.column
                                                    .map((t) =>
                                                        l ? yo.normal(e, t) : yo.ifTruthy(e, t),
                                                    )
                                                    .getOr(r),
                                                o,
                                            ),
                                    ...
                                    Qe(e, o.dom, { structure: s, style: a })
                            })
                    })(e, t, o, n),
                        e.focus()
                })
        ...
        qo = (e) => {
            ...
            const o = ((e, t) => {
                    ...
                    return Mo(o.getOrDie())
                })(e, t),
                l = {
                    type: 'tabpanel',
                    tabs: [{ title: 'General', name: 'general', items: go(e) }, ho(e, 'cell')],
                },
                n = { type: 'panel', items: [{ type: 'grid', columns: 2, items: go(e) }] }
                        ...
                        if (v(n) > 0) {
                            ...
                            a &&
                                ((e, t, o, l) => {
                                    const n = 1 === t.length
                                    N(t, (t) => {
                                        const r = n ? yo.normal(e, t) : yo.ifTruthy(e, t)
                                        ;((e, t) => {
                                            e.setAttrib('class', t.class),
                                                e.setStyle('height', Ct(t.height))
                                        })(r, o),
                                            ct(e) &&
                                                ((e, t) => {
                                                    e.setStyle(
                                            ...
                                            o.align !== l.align && (Je(e, t), Ke(e, t, o.align))
                                    })
                                })(e, t, l, o),
                                r &&
                                    ((e, t) => {
                                ...
                                Be(j.fromDom(t[0])).each((t) =>
                                    Qe(e, t.dom, { structure: r, style: a }),
                                )
                        }
                    })(e, t, o, n),
                        e.focus()
        ...
        Vo = (e) => {
            ...
            const o = M(t, (t) =>
                ...
                n = {
                    type: 'tabpanel',
                    tabs: [{ title: 'General', name: 'general', items: Ho(e) }, ho(e, 'row')],
                },
                r = { type: 'panel', items: [{ type: 'grid', columns: 2, items: Ho(e) }] }
            e.windowManager.open({
        ...
        Wo = (e, t, o, n) => {
            if ('TD' === t.tagName || 'TH' === t.tagName)
                ...
                for (let l = 0; l < t.children.length; l++) Wo(e, t.children[l], o, n)
        },
        $o = (e, t, o, l) => {
            const n = e.dom,
                r = l.getData(),
                ...
                e.undoManager.transact(() => {
                    ...
                    if (v(a) > 0) {
                        ;((e, t, o) => {
                            ...
                            if (
                                ((n.class = o.class),
                                (r.height = Ct(o.height)),
                                l.getAttrib(t, 'width') && !ut(e)
                                    ? (n.width = ((e) => (e ? e.replace(/px$/, '') : ''))(o.width))
                                    : (r.width = Ct(o.width)),
                                ut(e)
                                    ? ((r['border-width'] = Ct(o.border)),
                                      (r['border-spacing'] = Ct(o.cellspacing)))
                                    : ((n.border = o.border),
        ...
        Uo = (e, t) => {
                    ...
                    const o = wt(e),
                        ...
                        n = t
                            ? {
                                  ...
                                  bordercolor: Do(T(o, 'border-color').getOr('')),
                                  backgroundcolor: Do(T(o, 'background-color').getOr('')),
                              }
                            : {}
                    return {
                        height: '',
            ...
            !1 === t
                ? ((l = o.getParent(e.selection.getStart(), 'table', e.getBody())),
                  l
                      ...
                      : it(e) &&
                        ((n.borderstyle = ''), (n.bordercolor = ''), (n.backgroundcolor = '')))
                : ((n.cols = '1'),
                  (n.rows = '1'),
                  it(e) && ((n.borderstyle = ''), (n.bordercolor = ''), (n.backgroundcolor = '')))
            const r = ro(gt(e))
            ...
            const a = { type: 'grid', columns: 2, items: zo(e, r, t) },
                s = it(e)
                    ? {
                          type: 'tabpanel',
                          tabs: [{ title: 'General', name: 'general', items: [a] }, ho(e, 'table')],
                      }
                    : { type: 'panel', items: [a] }
            e.windowManager.open({
            ...
            const n = J('caption'),
                ...
                a = () =>
                    jt(vt(e), St(e)).bind((t) => {
                        return (
                            (o = Se(
                                Be(t),
                                jt(((e) => j.fromDom(e.selection.getEnd()))(e), St(e)).bind(Be),
                                (o, l) =>
                                    Y(o, l)
                                        ? n(t)
                                            ? f.some(
                ...
                s = (e) =>
                    Be(e.element).map((t) => {
                        ...
                        return {
                            mergeable: Ro(o, e).isSome(),
                            unmergeable: _o(o, e).isSome(),
                            locked: n,
                        }
                    }),
                c = () => {
            ...
            return (
                e.on('NodeChange ExecCommand TableSelectorChange', c),
                {
                    ...
                    onSetupTableWithCaption: (t) =>
                        d(t, g, (t) =>
                            Be(t.element, St(e)).exists((e) => ue(e, 'caption').isSome()),
                        ),
    ...
    var Xo = tinymce.util.Tools.resolve('tinymce.FakeClipboard')
    const Yo = (e) => {
            var t
            const o = null !== (t = Xo.read()) && void 0 !== t ? t : []
            return L(o, (t) => f.from(t.getType(e)))
        },
        Zo = () => Yo('x-tinymce/dom-table-rows'),
        el = () => Yo('x-tinymce/dom-table-columns')
    e.add('table', (e) => {
        const t = Qo(e)
        ;((e) => {
            const t = e.options.register
            t('table_border_widths', { processor: 'object[]', default: et }),
                t('table_border_styles', { processor: 'object[]', default: tt }),
                ...
                t('table_grid', { processor: 'boolean', default: !Ze.deviceType.isTouch() }),
            ...
            ((e) => {
                S(
                    {
                        mceTableProps: b(Uo, e, !1),
                        mceTableRowProps: b(Vo, e),
                        mceTableCellProps: b(qo, e),
                    },
                ...
                const o = (t) => () => e.execCommand(t),
                    ...
                    s = [
                        ...
                        l('tablepastecolumnbefore', {
                            ...
                            onSetup: t.onSetupPasteableColumn(el, 'onFirst'),
                        }),
                        l('tablepastecolumnafter', {
                            text: 'Paste column after',
                            icon: 'paste-column-after',
                            command: 'mceTablePasteColAfter',
                            onSetup: t.onSetupPasteableColumn(el, 'onLast'),
                        }),
                    ],
                    i = [
                        l('tablecellprops', {
                ...
                0 !== u.length &&
                    ...
                    e.queryCommandSupported('mceTableApplyCellStyle') &&
                        (e.ui.registry.addNestedMenuItem('tablecellvalign', {
                            ...
                            text: 'Vertical align',
                            getSubmenuItems: () =>
                                ao(e, $t, 'tablecellverticalalign', so(e, 'vertical-align')),
                            onSetup: t.onSetupCellOrRow,
                        }),
                        e.ui.registry.addNestedMenuItem('tablecellborderwidth', {
                            ...
                            text: 'Border width',
                            getSubmenuItems: () =>
                                ao(e, nt(e), 'tablecellborderwidth', so(e, 'border-width')),
                            onSetup: t.onSetupCellOrRow,
                        }),
                        e.ui.registry.addNestedMenuItem('tablecellborderstyle', {
                            ...
                            text: 'Border style',
                            getSubmenuItems: () =>
                                ao(e, rt(e), 'tablecellborderstyle', so(e, 'border-style')),
                            onSetup: t.onSetupCellOrRow,
                        }),
                        e.ui.registry.addNestedMenuItem('tablecellbackgroundcolor', {
                            icon: 'cell-background-color',
                            text: 'Background color',
                            getSubmenuItems: () => mo(e, ft(e), 'background-color'),
                            onSetup: t.onSetupCellOrRow,
                        }),
                        e.ui.registry.addNestedMenuItem('tablecellbordercolor', {
                            icon: 'cell-border-color',
                            text: 'Border color',
                            getSubmenuItems: () => mo(e, yt(e), 'border-color'),
                            onSetup: t.onSetupCellOrRow,
                        })),
                    n('tablecaption', {
                        icon: 'table-caption',
            ...
            ((e, t) => {
                e.ui.registry.addMenuButton('table', {
                    ...
                    icon: 'table',
                    fetch: (e) =>
                        e('inserttable | cell row column | advtablesort | tableprops deletetable'),
                })
                const o = (t) => () => e.execCommand(t),
                    l = (t, l) => {
                        e.queryCommandSupported(l.command) &&
                ...
                0 !== a.length &&
                    ...
                    e.queryCommandSupported('mceTableApplyCellStyle') &&
                        (e.ui.registry.addMenuButton('tablecellvalign', {
                            ...
                            fetch: io(e, $t, 'tablecellverticalalign', so(e, 'vertical-align')),
                            onSetup: t.onSetupCellOrRow,
                        }),
                        e.ui.registry.addMenuButton('tablecellborderwidth', {
                            icon: 'border-width',
                            tooltip: 'Border width',
                            fetch: io(e, nt(e), 'tablecellborderwidth', so(e, 'border-width')),
                            onSetup: t.onSetupCellOrRow,
                        }),
                        e.ui.registry.addMenuButton('tablecellborderstyle', {
                            icon: 'border-style',
                            tooltip: 'Border style',
                            fetch: io(e, rt(e), 'tablecellborderstyle', so(e, 'border-style')),
                            onSetup: t.onSetupCellOrRow,
                        }),
                        e.ui.registry.addMenuButton('tablecellbackgroundcolor', {
                            icon: 'cell-background-color',
                            tooltip: 'Background color',
                            fetch: (t) => t(mo(e, ft(e), 'background-color')),
                            onSetup: t.onSetupCellOrRow,
                        }),
                        e.ui.registry.addMenuButton('tablecellbordercolor', {
                            icon: 'cell-border-color',
                            tooltip: 'Border color',
                            fetch: (t) => t(mo(e, yt(e), 'border-color')),
                            onSetup: t.onSetupCellOrRow,
                        })),
                    n('tablecaption', {
