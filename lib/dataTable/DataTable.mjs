...
import { useDataProvider as ft } from "../dataProvider/DataProviderContext.mjs";
import gt from "../ui/Button/Button.mjs";
import { Table as ht } from "../ui/Table/Table.mjs";
function Rt({
  resource: r,
  columns: y,
  locale: i,
  ...
  const { getList: M, reorderList: $ } = ft(), [m, I] = h([]), [S, V] = h(!!(c != null && c.autoupdateTime)), { rowSelection: d, title: p, ...X } = c || {}, [D, q] = h([]), [K, G] = h([]), H = B(!0), N = z(
    (t, e) => {
      var n;
