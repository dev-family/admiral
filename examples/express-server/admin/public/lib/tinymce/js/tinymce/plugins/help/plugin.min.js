...
!(function () {
    ...
    const k = l(
            [
                ...
                { key: 'editimage', name: 'Edit Image', type: 'premium' },
            ...
            const t = (e) => `<a href="${e.url}" target="_blank" rel="noopener">${e.name}</a>`,
                n = (e) => {
                    const n = ((e) => {
                            const t = u(e.plugins),
                                n = a(e)
                            return o(n) ? t : c(t, (e) => !(((e, t) => r.call(e, t))(n, e) > -1))
                        })(e),
                        h = l(
                            n,
                            (n) =>
                ...
                h = {
                    ...
                    html: [
                        ((e) =>
                            null == e
                                ? ''
                                : '<div data-mce-tabstop="1" tabindex="-1">' + n(e) + '</div>')(e),
                        (() => {
                            const e = c(
                                    k,
                                    ({ key: e, type: t }) => 'autocorrect' !== e && 'premium' === t,
                                ),
        ...
        const { tabs: a, names: o } = ((e, t) => {
                const a = y(),
                    ...
                    r = (() => {
                        var e, t
                        const n =
                            '<a href="https://www.tiny.cloud/docs/tinymce/6/changelog/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" target="_blank">TinyMCE ' +
                            ((e = f.majorVersion),
                            (t = f.minorVersion),
                    ...
                    c = { [a.name]: a, [o.name]: o, [i.name]: i, [r.name]: r, ...t.get() }
                return s.from(n(e)).fold(
                    () =>
                        ((e) => {
                            const t = u(e),
            ...
            i = {
                ...
                tabs: ((e) => {
                    ...
                    l(o, (e) => {
                        return m((t = a), (n = e)) ? s.from(t[n]) : s.none()
                        var t, n
                    }),
                ),
            }
