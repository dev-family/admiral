    ...
    const s = 'undefined' != typeof window ? window : Function('return this;')(),
        r = (function (e, t, n) {
            ...
            var s = (function (e) {
                ...
                if (
                    (d && ((s.filename = d.src), d.hasAttribute('data-manual') && (s.manual = !0)),
                    !s.manual)
                ) {
        ...
        c = (e) => e && 'PRE' === e.nodeName && -1 !== e.className.indexOf('language-'),
        d = (e) => {
        ...
        g = (e) => {
            const s = ((e) =>
                ...
                r = ((c = s), ((e, t) => (0 < e.length ? n.some(e[0]) : n.none()))(c)).fold(
                    t(''),
                    (e) => e.value,
                ),
                i = ((e, t) =>
            ...
            e.windowManager.open({
                ...
                body: {
                    type: 'panel',
                    items: [
                        { type: 'selectbox', name: 'language', label: 'Language', items: s },
