...
export type { TablePaginationConfig, TableProps, TableRowSelection, ColumnsType as TableColumnsType, ColumnType as TableColumnType, SortOrder, } from './ui/Table/interfaces';
