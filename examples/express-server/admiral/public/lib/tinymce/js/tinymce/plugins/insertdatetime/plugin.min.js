...
!(function () {
    ...
    const t = (e) => (t) => t.options.get(e),
        ...
        c = (e, t) => {
            if ((e = '' + e).length < t) for (let r = 0; r < t - e.length; r++) e = '0' + e
            return e
        },
        d = (e, t, r = new Date()) =>
            (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
                '%D',
                '%m/%d/%Y',
            )).replace('%r', '%I:%M:%S %p')).replace('%Y', '' + r.getFullYear())).replace(
                '%y',
                '' + r.getYear(),
            )).replace('%m', c(r.getMonth() + 1, 2))).replace('%d', c(r.getDate(), 2))).replace(
                '%H',
                '' + c(r.getHours(), 2),
        ...
        ;((e) => {
            ...
            ((e) => {
                ...
                e.ui.registry.addSplitButton('insertdatetime', {
                    ...
                    select: (e) => e === r.get(),
                    fetch: (r) => {
                        r(p.map(t, (t) => ({ type: 'choiceitem', text: d(e, t), value: t })))
                    },
                    onAction: (e) => {
                        s(r.get())
                    },
