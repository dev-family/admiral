...
import { Location, RouterLocationState } from './interfaces.js';
type PageComponent = React.ComponentType<any>;
export type PageModules = Record<string, {
    default: PageComponent;
}>;
interface CreateRoutesConfig {
    withAuth?: boolean;
}
export declare function createRoutesFrom(modules: PageModules, config?: CreateRoutesConfig): () => import("react/jsx-runtime").JSX.Element;
