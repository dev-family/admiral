...
!(function () {
    ...
    const A = (e) => (t) => ((e) => e.dom.nodeType)(t) === e,
        ...
        _ = (e) => {
            ...
            return B(C(t)).fold(() => n.body.contains(t), ((r = _), (o = V), (e) => r(o(e))))
            var r, o
        },
        j = (e, t) => {
        ...
        ne = [
            {
                ...
                search: (e) =>
                    O(e, 'edge/') && O(e, 'chrome') && O(e, 'safari') && O(e, 'applewebkit'),
            },
            {
                name: 'Chromium',
                brand: 'Chromium',
    ...
    const Te = (e, t) => ({ left: e, top: t, translate: (n, r) => Te(e + n, t + r) }),
        ke = Te,
        Ce = (e) => {
            const t = void 0 === e ? window : e
            return Oe().browser.isFirefox() ? f.none() : f.from(t.visualViewport)
        },
        Ae = (e, t, n, r) => ({ x: e, y: t, width: n, height: r, right: e + n, bottom: t + r }),
        Re = (e) => {
            const t = void 0 === e ? window : e,
                n = t.document,
                r = ((e) => {
            ...
            return Ce(t).fold(
                ...
                (e) =>
                    Ae(Math.max(e.pageLeft, r.left), Math.max(e.pageTop, r.top), e.width, e.height),
            )
        },
        Le = (e, t, n) =>
            Ce(n)
