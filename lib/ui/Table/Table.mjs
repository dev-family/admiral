...
import { convertChildrenToColumns as Ce } from "rc-table/lib/hooks/useColumns";
...
import { DragHandle as Oe } from "./components/DragHandle.mjs";
import { DraggableRow as We } from "./components/DraggableRow.mjs";
import { DraggableWrapper as Ae } from "./components/DraggableWrapper.mjs";
import { Pagination as ke } from "../Pagination/Pagination.mjs";
import { enUS as He } from "./locales/enUS.mjs";
...
function Ge({
  ...
  return /* @__PURE__ */ r(
    Ie,
    {
      ...
      onDragEnd: me,
      onDragStart: pe,
      children: /* @__PURE__ */ r("div", { ref: de, className: B, style: R, children: /* @__PURE__ */ Y(je, { spinning: !1, ...v, children: [
        k,
        /* @__PURE__ */ r(
          V,
          {
