...
!(function () {
    ...
    const o = ('allow_html_in_named_anchor', (e) => e.options.get('allow_html_in_named_anchor'))
    const a = 'a:not([href])',
        r = (e) => !e,
        ...
        d = (e) =>
            ((e) => e && r(e.attr('href')) && !r(e.attr('id') || e.attr('name')))(e) &&
            !e.firstChild,
        m = (e) => (t) => {
        ...
        ;((e) => {
            ...
            ((e) => {
                e.ui.registry.addToggleButton('anchor', {
                    ...
                    onSetup: (t) =>
                        e.selection.selectorChangedWithUnbind('a:not([href])', t.setActive).unbind,
                }),
